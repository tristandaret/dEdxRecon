...
//------------------------------IDs-----------------------//
int Event::Get_EventNber() const
{
   return m_EventNber;
}
int Event::Get_EntryNber() const
{
   return m_EntryNber;
}
...
int Event::Get_NberOfModule() const
{
   return m_NberOfModules;
}
...
const Model_ChargeI *Event::Get_Model_ChargeI()
{
