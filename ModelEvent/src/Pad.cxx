...
const Model_ChargeI *Pad::Get_Model_ChargeI() const
{
   return p_Model_ChargeI;
}

std::string Pad::Get_PadName() const
{
   return m_PadName;
}
int Pad::Get_iX() const
{
   return m_iX;
}
int Pad::Get_iY() const
{
   return m_iY;
}
int Pad::Get_ModuleNber() const
{
   return m_ModuleNber;
}

double Pad::Get_XPad() const
{
   return (m_XH + m_XL) / 2.;
}
double Pad::Get_YPad() const
{
   return (m_YH + m_YL) / 2.;
}
double Pad::Get_LX() const
{
   return (m_XH - m_XL);
}
double Pad::Get_LY() const
{
   return (m_YH - m_YL);
}

double Pad::Get_XL() const
{
   return m_XL;
}
double Pad::Get_XH() const
{
   return m_XH;
}
double Pad::Get_YL() const
{
   return m_YL;
}
double Pad::Get_YH() const
{
   return m_YH;
}

int Pad::Get_EventNber() const
{
   return m_EventNber;
}

int Pad::Get_EntryNber() const
{
   return m_EntryNber;
}

int Pad::IsValid() const
{
   return m_IsValid;
}
void Pad::Validate()
...
double Pad::Get_AMax() const
{
   return m_AMax;
}
double Pad::Get_TMax() const
{
   return m_TMax;
}
...
void Pad::SetEdges(const double &XL, const double &XH, const double &YL, const double &YH)
{
...
double Pad::Get_AMax_FromSet() const
{
   return m_AMax_FromSet;
}
double Pad::Get_TMax_FromSet() const
{
   return m_TMax_FromSet;
}

double Pad::Get_AMax_WF() const
{
   return m_AMax_WF;
}
double Pad::Get_TMax_WF() const
{
   return m_TMax_WF;
}

double Pad::Get_AMax_WF_01() const
{
   return m_AMax_WF_01;
}
double Pad::Get_TMax_WF_01() const
{
   return m_TMax_WF_01;
}

double Pad::Get_AMax_FIT() const
{
   return m_AMax_FIT;
}
double Pad::Get_TMax_FIT() const
{
   return m_TMax_FIT;
}
int Pad::Get_FIT_Status() const
{
   return m_FIT_Status;
}
double Pad::Get_FIT_A0P() const
{
   return m_FIT_A0P;
}
double Pad::Get_FIT_A0M() const
{
   return m_FIT_A0M;
}
double Pad::Get_FIT_X0() const
{
   return m_FIT_X0;
}
double Pad::Get_FIT_Y0() const
{
   return m_FIT_Y0;
}

double Pad::Get_FIT_Xmin() const
{
   return m_FIT_Xmin;
}
double Pad::Get_FIT_Xmax() const
{
   return m_FIT_Xmax;
}

double Pad::Get_AMax_True() const
{
   return m_AMax_True;
}
double Pad::Get_TMax_True() const
{
   return m_TMax_True;
}
void Pad::Set_AMax_True(const double &AMax)
{
   m_AMax_True = AMax;
}
void Pad::Set_TMax_True(const double &TMax)
{
   m_TMax_True = TMax;
}
...
//------------------------------Signal Simulation-----------------------//
void Pad::SetSignalModel(const double &Time0, const double &XTrue, const double &YTrue)
{
   m_Time0 = Time0;
   m_XTrue = XTrue;
   m_YTrue = YTrue;
...
double Pad::Get_Time0() const
{
   return m_Time0;
}
double Pad::Get_XTrue() const
{
   return m_XTrue;
}
double Pad::Get_YTrue() const
{
   return m_YTrue;
}
