...
Cluster::Cluster(const int &EventNber, const int &EntryNber, const int &ModuleNber)
{
...
int Cluster::Get_EventNber() const
{
   return m_EventNber;
}

int Cluster::Get_EntryNber() const
{
   return m_EntryNber;
}

int Cluster::Get_ModuleNber() const
{
   return m_ModuleNber;
}

int Cluster::IsValid() const
{
   return m_isValid;
}
...
int Cluster::Get_NberOfPads() const
{
   return m_NberOfPads;
}
Pad *Cluster::Get_Pad(const int &Index1D) const
{
   return V_Pad[Index1D];
}

double Cluster::Get_Acluster() const
{
   return m_Acluster;
}
double Cluster::Get_XWeight() const
{
   return m_XWeight;
}
double Cluster::Get_YWeight() const
{
   return m_YWeight;
}

Pad *Cluster::Get_LeadingPad() const
{
   return Pad_Leading;
}
double Cluster::Get_YLeading() const
{
   return Pad_Leading->Get_YPad();
}
double Cluster::Get_TMaxLeading() const
{
   return Pad_Leading->Get_TMax();
}

Pad *Cluster::Get_NextLeadingPad() const
{
   return Pad_NextLeading;
}
Pad *Cluster::Get_NextNextLeadingPad() const
{
   return Pad_NextNextLeading;
}

double Cluster::Get_AMaxLeading() const
{
   return Pad_Leading->Get_AMax();
}
...
//--------------------------------------------------------------------------//
void Cluster::Set_XTrack(const double &XTrack)
{
   m_XTrack = XTrack;
}
void Cluster::Set_YTrack(const double &YTrack)
{
   m_YTrack = YTrack;
}

void Cluster::Set_eXTrack(const double &eXTrack)
{
   m_eXTrack = eXTrack;
}
void Cluster::Set_eYTrack(const double &eYTrack)
{
   m_eYTrack = eYTrack;
}

int Cluster::StatusFit()
{
   return m_StatusFit;
}

double Cluster::Get_XTrack() const
{
   return m_XTrack;
}
double Cluster::Get_eXTrack() const
{
   return m_eXTrack;
}
double Cluster::Get_YTrack() const
{
   return m_YTrack;
}
double Cluster::Get_eYTrack() const
{
   return m_eYTrack;
}

double Cluster::Get_Chi2Min() const
{
   return m_Chi2Min;
}
...
int Cluster::StatusFit_Horizontal()
{
   return m_StatusFit_Horizontal;
}

void Cluster::SetEval_Horizontal(TF1 *pTF1)
{
   p_TF1_Horizontal = pTF1;
}
...
int Cluster::StatusFit_Diagonal()
{
   return m_StatusFit_Diagonal;
}

void Cluster::SetEval_Diagonal(TF1 *pTF1)
{
   p_TF1_Diagonal = pTF1;
}
