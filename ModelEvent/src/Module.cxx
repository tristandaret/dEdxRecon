 ...
 * Project: dEdxRecon
 *
 * Brief: Implementation of the Module class which represents a detector
 *        module composed of pads and clusters. Provides methods to manage
 *        module-level collections used by reconstruction.
 *
 * Contents: Module constructor/destructor and module management helpers.
 *
 * Notes: See Module.h for public API.
 ***************************************************************************/

#include "Module.h"

Module::Module(const int &EventNber, const int &EntryNber,
...
Module::~Module() {
  ...
  if (VerboseDelete == 1)
    std::cout << " Module Destructor "
              ...
              << m_EntryNber << " m_ModuleNber " << m_ModuleNber << std::endl;
  Clear_Clusters();
  delete p_TrackOfTheModule;
  p_TrackOfTheModule = 0;
}

int Module::IsValid() const { return m_IsValid; }
void Module::Validate() { m_IsValid = 1; }
...
void Module::Add_Pad(Pad *pPad) { ROBoard::Add_Pad(pPad); }
...
int Module::Get_NberOfCluster() const { return m_NberOfClusters; }
Cluster *Module::Get_Cluster(const int &Index1D) { return V_Cluster[Index1D]; }
...
int Module::Get_EventNber() const { return m_EventNber; }
int Module::Get_EntryNber() const { return m_EntryNber; }
int Module::Get_ModuleNber() const { return m_ModuleNber; }

const Track *Module::GiveMe_ModuleTrack() { return p_TrackOfTheModule; }
