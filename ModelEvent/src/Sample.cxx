...
Sample::~Sample()
{
   ...
   delete p_Model_ReadOutGeometry;
   p_Model_ReadOutGeometry = 0;
   delete p_Model_Electronics;
   p_Model_Electronics = 0;
   delete p_Model_ChargeI;
   p_Model_ChargeI = 0;
}
...
int Sample::Get_NberOfEvents() const
{
   return m_NberOfEvents;
}
Event *Sample::Get_Event(int Index1D)
{
   return V_Event[Index1D];
}
...
void Sample::Set_Model_ReadOutGeometry(Model_ReadOutGeometry *pModel_ReadOutGeometry)
{
   p_Model_ReadOutGeometry = pModel_ReadOutGeometry;
}
void Sample::Set_Model_Electronics(Model_Electronics *pModel_Electronics)
{
   p_Model_Electronics = pModel_Electronics;
}
void Sample::Set_Model_Charge(Model_ChargeI *pModel_ChargeI)
{
   p_Model_ChargeI = pModel_ChargeI;
}

Model_ReadOutGeometry *Sample::Get_Model_ReadOutGeometry()
{
   return p_Model_ReadOutGeometry;
}
Model_Electronics *Sample::Get_Model_Electronics()
{
   return p_Model_Electronics;
}
Model_ChargeI *Sample::Get_Model_ChargeI()
{
   return p_Model_ChargeI;
}

//--------------------------------------------------------------------------//
int Sample::StatusFit()
{
   return m_StatusFit;
}

void Sample::Set_RC(const double &RC)
{
   m_RC = RC;
}
void Sample::Set_DD(const double &DD)
{
   m_DD = DD;
}

double Sample::Get_RC() const
{
   return m_RC;
}
double Sample::Get_eRC() const
{
   return m_eRC;
}

double Sample::Get_DD() const
{
   return m_DD;
}
double Sample::Get_eDD() const
{
   return m_eDD;
}

double Sample::Get_Chi2Min() const
{
   return m_Chi2Min;
}

double Sample::Get_RC_BeforeMinimisation() const
{
   return m_RC_BeforeMinimisation;
}
double Sample::Get_DD_BeforeMinimisation() const
{
   return m_DD_BeforeMinimisation;
}
