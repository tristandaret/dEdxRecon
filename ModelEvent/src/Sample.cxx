 ...
 * Project: dEdxRecon
 *
 * Brief: Implementation of the Sample class which represents a dataset or
 *        collection of events. Provides I/O helpers and iteration utilities
 *        used by higher-level reconstruction routines.
 *
 * Contents: Sample constructor/destructor and dataset management methods.
 *
 * Notes: See Sample.h for the API.
 ***************************************************************************/
...
void Sample::Set_Model_ReadOutGeometry(
...
void Sample::GetFilePRF(int &FilePRF_Exist, double &Norm, double &a2,
                        double &a4, double &b2, double &b4) {
