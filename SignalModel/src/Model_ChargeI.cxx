...
void Model_ChargeI::Set_RC     (const double& RC     ) { m_RC     = RC     ; SetSecondaries() ; }
void Model_ChargeI::Set_Width  (const double& Width  ) { m_Width  = Width  ; SetSecondaries() ; }
void Model_ChargeI::Set_Gain   (const double& Gain   ) { m_Gain   = Gain   ; SetSecondaries() ; }
