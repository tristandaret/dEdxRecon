    ...
    if(ISAMPLE==12){
      ...
      for (int iMod = iMod_Min ; iMod< iMod_Max; iMod++){
        ...
        for (int iFl = iFl_Min ; iFl< iFl_Max; iFl++){
          ...
          double DD_Sample = ZZ + 40. ;
          DD_Sample *= std::pow((350.00/237.00),2) ;
...
//    EvtFil = "OUT_SampleGenerator/Sim_01_NoSmearing.root" ;
//    EvtFil = "OUT_SampleGenerator/Sim_01_CteSigma.root" ;
      EvtFil = "OUT_SampleGenerator/Sim_01_SqrtASigma.root" ;
