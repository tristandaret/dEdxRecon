...
{  
  ...
  std::cout << std::endl ;
  std::cout << "Uploader_David::Uploader_David "<< std::endl ;
...
Uploader_David::~Uploader_David()
{
//std::cout << " In Uploader_David::~Uploader_David() " << std::endl ;
}

Event* Uploader_David::GiveMe_Event(
                               const int& iEvent, 
...
//             << " beforeMerging= " << beforeMerging
//             << " m_BeforeMerging " << m_BeforeMerging
//             << std::endl; 
...
//   std::cout << " Uploader_David::GiveMe_Event "
//             << " ModuleNber_Cur= " << ModuleNber_Cur
//             << " ModuleNber_Input= " << ModuleNber_Input
//             << std::endl; 
...
//       std::cout << " Uploader_David::GiveMe_Event "
//                 << "  "
//                 << "  Before Set_Data_2Use"
//                 << std::endl; 
      pPad->Set_Data_2Use(Data_to_Use) ;
              
//       std::cout << " Uploader_David::GiveMe_Event "
//                 << "  "
//                 << "  Before pModule->Add_Pad"
//                 << std::endl; 
      pModule->Add_Pad(pPad ) ;
      
//       std::cout << " Uploader_David::GiveMe_Event "
//                 << "  "
//                 << "  Before pCluster->Add_Pad(pPad)"
//                 << std::endl; 
      pCluster->Add_Pad(pPad) ;
//       std::cout << " Uploader_David::GiveMe_Event "
//                 << "  "
//                 << "  After pCluster->Add_Pad(pPad)"
//                 << std::endl; 

    }
//       std::cout << " Uploader_David::GiveMe_Event "
//                 << " NberOfPads= " << NberOfPads
//                 << std::endl; 
    if (NberOfPads!=0){
      pCluster->DoClosure() ;
...
//   std::cout << " Uploader_David::GiveMe_Event "
//             << " NClusters= " << NClusters
//             << " pModule->Get_ModuleNber= " << pModule->Get_ModuleNber()
//             << std::endl; 
    if (NClusters!=0){
...
void Uploader_David::SetBeforeMerging(const int& i_SetBeforeMerging)
{
  m_BeforeMerging = i_SetBeforeMerging;

  std::cout << std::endl ;
  std::cout << "Uploader_David::SetBeforeMerging" << std::endl ;
  std::cout << "m_BeforeMerging Set to " << m_BeforeMerging << std::endl ;
  std::cout << std::endl ;

}

void Uploader_David::Setwap_XY(const int& i_Swap_XY)
{
  m_Swap_XY = i_Swap_XY;

  std::cout << std::endl ;
  std::cout << "Uploader_David::Setwap_XY" << std::endl ;
  std::cout << "m_Swap_XY Set to " << m_Swap_XY << std::endl ;
  std::cout << std::endl ;

}

void Uploader_David::Init()
{
   multiplicity = 0;
   charge = 0;
   residual = 0;
