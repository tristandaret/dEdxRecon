...
void DrawOut_Phiscan(const std::string& inputDir, const std::string& Comment, const std::string& WFversion, const std::string& zdrift)
{
  ...
  int phi_arr[] = {0, 5, 10, 20, 30, 30, 40 ,45} ;
  for(int iphi = 0 ; iphi < nphi ; iphi++){
    if(iphi == 0)     pFile = TFile::Open(TString("OUT_PID/DESY21_zscan/DESY21_zscan_PT200/DESY21_z" + zdrift + "_PT200/3_DESY21_z" + zdrift + "_PT200_dEdx" + Comment + ".root"));
...
void DrawOut_Phiscan_Z(const std::string& inputDir, const std::string& Comment, const std::string& WFversion)
{
  ...
  for(int iphi = 0 ; iphi < nphi ; iphi++){
    if(iphi == 0){
      pTFile_5 = TFile::Open(TString("OUT_PID/DESY21_zscan/DESY21_zscan_PT200/DESY21_zm40_PT200/3_DESY21_zm40_PT200_dEdx" + Comment + ".root")) ;
      pTFile_55 = TFile::Open(TString("OUT_PID/DESY21_zscan/DESY21_zscan_PT200/DESY21_z460_PT200/3_DESY21_z460_PT200_dEdx" + Comment + ".root")) ;
      pTFile_95 = TFile::Open(TString("OUT_PID/DESY21_zscan/DESY21_zscan_PT200/DESY21_z860_PT200/3_DESY21_z860_PT200_dEdx" + Comment + ".root")) ;
...
void DrawOut_verif(const std::string& OutDir, const std::string& Comment){
  ...
  // Draw out
  std::string OutputFile        = "OUT_PID/DESY21_phi/Verif_vertVSdiag" + Comment + ".pdf" ;
  std::string OutputFile_Beg    = OutputFile + "(" ;
  std::string OutputFile_End    = OutputFile + ")" ;
  ...
  for(int i = 0 ; i < 3 ; i++){
    OutputFile                    = "OUT_PID/DESY21_phi/Verif_vertVSdiag_z" + ztrue[i] + Comment + ".jpg" ;
    pTCanvas->                      Clear() ;
...
void DrawOut_corrections(){
  ...
  // Draw out
  std::string OutputFile        = "OUT_PID/DESY21_phi/Correction_functions_WFmax_correction.pdf" ;
  std::string OutputFile_Beg    = OutputFile + "(" ;
  std::string OutputFile_End    = OutputFile + ")" ;
...
void DrawOut_Systematics(const std::string& inputDir, const std::string& Comment, const std::string& scan)
{
  ...
  if(scan=="phi") file[0] = "OUT_PID/DESY21_zscan/DESY21_zscan_PT200/DESY21_z460_PT200/3_DESY21_z460_PT200_dEdx";
