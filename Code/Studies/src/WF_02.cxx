...
//Page 1
  ...
  aostringstream_PDF << "OUT_Studies/WF_02_";
...
//Page 2
  pTCanvas =  new TCanvas("Bla", "Bla", 180, 10, 3600, 2400) ;
    ...
    pTMultiGraph_ADC->GetXaxis()->SetLimits( -1.E-6 , 5.E-6);
  ...
  aostringstream_PNG_Page_2 << "OUT_Studies/WF_02_Page_2_";
...
//Page 3
  ...
  aostringstream_PNG_Page_3 << "OUT_Studies/WF_02_Page_3_";
