...
//
  std::cout << std::endl ;
  std::cout << "Entering Main_AOBt_PV1_BASE" << std::endl ;
  ...
  std::string str_PRFfile_Fixed_DD    (argv[5]) ;
  std::string str_Uploader            (argv[6]) ;
  std::string str_StartFrom           (argv[7]) ;
  std::string str_iOpt_Initial_YT_fit (argv[8]) ;
  std::string str_iOpt_TrackType      (argv[9]) ;
  ...
  std::string PRFfile_Fixed_DD    = str_PRFfile_Fixed_DD    ;
