#include "Analysis_JF/CERN22_01_ZSCAN.h"
#include "Misc/Util.h"
...
//
  TCanvas* pTCanvas = 0 ;
  std::string Str_Out_PDF     = OUTDirName + "CERN22_01_PV2_RC_ZSCAN_01.pdf" ; 
...
//
  std::vector< double > v_AVG_Mod4 ; std::vector< double > v_DIFF_Mod4 ;
  std::vector< double > v_AVG_Mod5 ; std::vector< double > v_DIFF_Mod5 ;
  std::vector< double > v_AVG_Mod6 ; std::vector< double > v_DIFF_Mod6 ;
  std::vector< double > v_AVG_Mod7 ; std::vector< double > v_DIFF_Mod7 ;
  ...
  for (int iProc = iProc_Min ; iProc< iProc_Max; iProc++){
    ...
    if ( iProc == 11 ) Procedure = "PV2" ;
    
    if ( iProc ==  3 ) v_CTD.push_back( 300. ) ;
    if ( iProc ==  4 ) v_CTD.push_back( 310. ) ;
    if ( iProc ==  5 ) v_CTD.push_back( 320. ) ;
    if ( iProc ==  6 ) v_CTD.push_back( 330. ) ;
    if ( iProc ==  7 ) v_CTD.push_back( 340. ) ;
    if ( iProc ==  8 ) v_CTD.push_back( 350. ) ;
    if ( iProc ==  9 ) v_CTD.push_back( 360. ) ;
    if ( iProc == 10 ) v_CTD.push_back( 370. ) ;
    if ( iProc == 11 ) v_CTD.push_back( 380. ) ;
    ...
    for (int iMod = iMod_Min ; iMod< iMod_Max; iMod++){
      ...
      if ( iProc ==  2 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=350 #mu m/#sqrt{cm}"   ;

      if ( iProc ==  3 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=300 #mu m/#sqrt{cm}"   ;   
      if ( iProc ==  4 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=310 #mu m/#sqrt{cm}"   ;
      if ( iProc ==  5 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=320 #mu m/#sqrt{cm}"   ;
      if ( iProc ==  6 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=330 #mu m/#sqrt{cm}"   ;   
      if ( iProc ==  7 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=340 #mu m/#sqrt{cm}"   ;
      if ( iProc ==  8 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=350 #mu m/#sqrt{cm}"   ;
      if ( iProc ==  9 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=360 #mu m/#sqrt{cm}"   ;   
      if ( iProc == 10 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=370 #mu m/#sqrt{cm}"   ;
      if ( iProc == 11 ) aostringstream_pTMultiGraph << "Fit peak + C_{TD}=380 #mu m/#sqrt{cm}"   ;
      ...
      pTMultiGraph->SetTitle((aostringstream_pTMultiGraph.str()).c_str());
        ...
        std::string SampleSet_Specific = "C22_ZSCAN_25V" ;
        ...
        if ( iProc ==  1 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V" ;
        if ( iProc ==  2 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_350_00" ;
        
        if ( iProc ==  3 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_300_00" ;
        if ( iProc ==  4 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_310_00" ;
        if ( iProc ==  5 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_320_00" ;
        if ( iProc ==  6 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_330_00" ;
        if ( iProc ==  7 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_340_00" ;
        if ( iProc ==  8 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_350_00" ;
        if ( iProc ==  9 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_360_00" ;
        if ( iProc == 10 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_370_00" ;
        if ( iProc == 11 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_380_00" ;
...
//--------------------RC_VS_Z-------------------------//
        ...
        for (int iFile = 0 ; iFile< iFile_Max; iFile++){
          ...
          if (iFile==2 ) continue ; //Skip All_ERAMS_350V_412ns_e+_0p5GeV_25V_z415_iter0.root
          if (iFile==5 ) continue ; //Skip All_ERAMS_350V_412ns_e+_0p5GeV_25V_z572_noCollim_iter0.root
          
//          if (iFile==4 ) continue ; //Skip All_ERAMS_350V_412ns_e+_0p5GeV_25V_z572_iter0.root <= Pb in V5
        ...
        if ( iProc >=  3 ){
          if (iMod==4) { v_AVG_Mod4.push_back(AVG ) ; v_DIFF_Mod4.push_back(DIFF ) ; }
          if (iMod==5) { v_AVG_Mod5.push_back(AVG ) ; v_DIFF_Mod5.push_back(DIFF ) ; }
          if (iMod==6) { v_AVG_Mod6.push_back(AVG ) ; v_DIFF_Mod6.push_back(DIFF ) ; }
          if (iMod==7) { v_AVG_Mod7.push_back(AVG ) ; v_DIFF_Mod7.push_back(DIFF ) ; }
        }
        ...
        aostringstream_pTLegend << " %"   ;
        pTLegend->AddEntry( (TObject*)0 , (aostringstream_pTLegend.str()).c_str(), "" );

//--------------------RC_VS_Z-------------------------//
      
//--------------------RC_VS_Z-------------------------//
      pTCanvas->cd(iMod-4+1) ;
...
//
  ...
  for (int iTem = 0 ; iTem< iTem_Max; iTem++){
    std::cout 
      << " v_CTD " << v_CTD[iTem]
      << " v_AVG_Mod4 " << std::setw(4) << std::setprecision(0) << v_AVG_Mod4[iTem] << " v_DIFF_Mod4 " << std::setw(4) << std::setprecision(0) << v_DIFF_Mod4[iTem]
      << " v_AVG_Mod5 " << std::setw(4) << std::setprecision(0) << v_AVG_Mod5[iTem] << " v_DIFF_Mod5 " << std::setw(4) << std::setprecision(0) << v_DIFF_Mod5[iTem]
      << " v_AVG_Mod6 " << std::setw(4) << std::setprecision(0) << v_AVG_Mod6[iTem] << " v_DIFF_Mod6 " << std::setw(4) << std::setprecision(0) << v_DIFF_Mod6[iTem]
      << " v_AVG_Mod7 " << std::setw(4) << std::setprecision(0) << v_AVG_Mod7[iTem] << " v_DIFF_Mod7 " << std::setw(4) << std::setprecision(0) << v_DIFF_Mod7[iTem]
      << std::endl ;
  }
...
//
   ...
   for (int iMod = iMod_Min ; iMod< iMod_Max; iMod++){
      ...
      aostringstream_pTMultiGraph_AVG << " " << CERN22_01_Mod2Erams( iMod ) ;
      ...
      aostringstream_pTMultiGraph_DIFF << " " << CERN22_01_Mod2Erams( iMod ) ;
...
//
      ...
      for (int iTem = 0 ; iTem< iTem_Max; iTem++){
        double AVG = 0 ; 
        double DIFF = 0 ; 
        if (iMod==4) { AVG = v_AVG_Mod4[iTem] ; DIFF = v_DIFF_Mod4[iTem] ; }
        if (iMod==5) { AVG = v_AVG_Mod5[iTem] ; DIFF = v_DIFF_Mod5[iTem] ; }
        if (iMod==6) { AVG = v_AVG_Mod6[iTem] ; DIFF = v_DIFF_Mod6[iTem] ; }
        if (iMod==7) { AVG = v_AVG_Mod7[iTem] ; DIFF = v_DIFF_Mod7[iTem] ; }
      ...
      pTMultiGraph_AVG->GetXaxis()->SetLimits(290.,380.);
...
//
  TCanvas* pTCanvas = 0 ;
  std::string Str_Out_PDF     = OUTDirName + "CERN22_01_PV2_RESO_ZSCAN_01.pdf" ; 
  std::string Str_Out_PDF_Beg = Str_Out_PDF + "(" ;
  std::string Str_Out_PDF_End = Str_Out_PDF + ")" ;
...
//
      ...
      if ( iAna == 0 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V" ;
      if ( iAna == 1 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V" ;
      if ( iAna == 2 ) aostringstream_AnalyseName <<  "C22_ZSCAN_25V_TD_350_00" ;
...
//        if (iFile==4 ) continue ; //Skip All_ERAMS_350V_412ns_e+_0p5GeV_25V_z572_iter0.root <= Pb in V5
        ...
        if (aReadRootFile.pTGraphErrors_Residual_Sigma_VS_Col){                           
          ...
          if (iAna==0){
            std::cout 
              << " iAna    " << iAna
              << " iMod    " << iMod
              << " ZScan    " << std::setw(5) << std::setprecision(0) << ZScan
              ;
            std::cout
      ...
      TF1* pTF1 = new TF1("fit1","sqrt([0]*[0] + 237.*237.*((x+40)/10.) /[1])",-40.0, 1000.);
...
//--------------------Sigma_VS_Z-------------------------//
  ...
  for (int iAna = iAna_Min ; iAna< iAna_Max; iAna++){
    ...
    for (int iMod = iMod_Min ; iMod< iMod_Max; iMod++){
      ...
      double Vmin = pTCanvas->cd(iMod-4+1)->GetUymin() ;
      double Vmax = pTCanvas->cd(iMod-4+1)->GetUymax() ;
      TLine* pTLineV = new TLine( -40.  , Vmin , -40. , Vmax ) ;
...
//
  TCanvas* pTCanvas = 0 ;
  std::string Str_Out_PDF     = OUTDirName + "CERN22_01_PV3_RC_ZSCAN_01.pdf" ; 
  std::string Str_Out_PDF_Beg = Str_Out_PDF + "(" ;
  std::string Str_Out_PDF_End = Str_Out_PDF + ")" ;
...
//
  TCanvas* pTCanvas = 0 ;
  std::string Str_Out_PDF     = OUTDirName + "CERN22_01_PV3_RESO_ZSCAN_01.pdf" ; 
  std::string Str_Out_PDF_Beg = Str_Out_PDF + "(" ;
  std::string Str_Out_PDF_End = Str_Out_PDF + ")" ;
...
//
  ...
  for (int iAna = iAna_Min ; iAna< iAna_Max; iAna++){
    std::string Procedure = "BIDON" ;
    if (iAna==0) Procedure = "PV0" ;
    if (iAna==1) Procedure = "PV3" ;
    if (iAna==2) Procedure = "PV3" ;
