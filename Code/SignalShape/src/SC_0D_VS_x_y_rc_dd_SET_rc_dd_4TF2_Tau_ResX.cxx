...
SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Tau_ResX::SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Tau_ResX(
...
double SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Tau_ResX::Eval(const double& vX,const double& vY)
{
 double A = 0. ;
 double B = 0. ;
 double C = 0. ;
 p_SC_0D_VS_x_y_rc_dd_SET_rc_dd->Eval_Tau_CMat(
                                                 m_V_Direction    , 
                                                 vX               , 
                                                 vY               ,
                                                 m_Var_Min_X      , 
...
//   std::cout << "SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Tau_ResX::Eval" << std::endl;
...
double SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Tau_ResX::operator() (double *x, double *par)
{
  double vX  = x[0]   ;
  double vY  = x[1]   ;
  return Eval(vX,vY) ;
