...
SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResY::SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResY(
...
double SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResY::Eval(const double& vX,const double& vY)
{
 double A = 0. ;
 double B = 0. ;
 double C = 0. ;
 p_SC_0D_VS_x_y_rc_dd_SET_rc_dd->Eval_Alpha_CMat(
                                                 m_V_Direction    , 
                                                 vX               , 
                                                 vY               ,
                                                 m_Var_Min_X      , 
  ...
  return ( std::sqrt(B)*1E-2/1E-6 ) ;
}

double SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResY::operator() (double *x, double *par)
{
  double vX  = x[0]   ;
  double vY  = x[1]   ;
  return Eval(vX,vY) ;
