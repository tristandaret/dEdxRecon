...
SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResX::SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResX(
...
double SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResX::Eval(const double& vX,const double& vY)
{
 double A = 0. ;
 double B = 0. ;
 double C = 0. ;
...
double SC_0D_VS_x_y_rc_dd_SET_rc_dd_4TF2_Alpha_ResX::operator() (double *x, double *par)
{
  double vX  = x[0]   ;
  double vY  = x[1]   ;
  return Eval(vX,vY) ;
