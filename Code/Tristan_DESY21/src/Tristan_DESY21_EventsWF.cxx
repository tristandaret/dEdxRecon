...
void Tristan_DESY21_EventsWF(Sample& aSample, const int& ModuleNber , const std::string& TAG, std::string Stage, const int& pt, const int& zDrift)
{
  ...
  dirEvtDisp << "OUT_Tristan_pt" << pt << "/z" << zDrift << "/" << Stage << "/Event_Displays/" ;
...
int NEvents = aSample.Get_NberOfEvents() ;
  ...
  dirWFstring << "OUT_Tristan_pt" << pt << "/z" << zDrift << "/" << Stage << "/Waveforms/" ;
