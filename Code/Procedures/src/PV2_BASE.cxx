...
//
  std::string AnalyseName = "PV2_" + Flavor ;
...
//  Graphics Page 2
    ...
    Input_pTH2F_Alpha2_VS_Alpha3onAlpha2->Draw("colz");
      ...
      for (int iYT = 0 ; iYT< iYT_Max; iYT++){
        ...
        double nPRFP = aSC_VS_x_rc_dd.Eval_AlphaPRF(YTYPP*1.E2, RC_Last,DD_Sample) ;
        double nPRFM = aSC_VS_x_rc_dd.Eval_AlphaPRF(YTYPM*1.E2, RC_Last,DD_Sample) ;
        
        double nTP = aSC_VS_x_rc_dd.Eval_TauPRF(YTYPP*1.E2, RC_Last,DD_Sample) ;
        double nTM = aSC_VS_x_rc_dd.Eval_TauPRF(YTYPM*1.E2, RC_Last,DD_Sample) ;
...
//-------------------------------Fit--------------------------------//
    ...
    int FitResult = Do_SampleFit_PV2(aSample, ModuleNber ,pTF1_3D_LUT_FIX_DD) ;
    RCfit_Kounter_Fit += 1 ;
...
//
    ...
    int       NODF_RCfit    = aSample.FitRes_PV2_Get_NberOfTermsInChi2() - 1 ;
    std::cout << std::endl ;
...
//-------------------------------Do cluster position fit-----------------------------//
    ...
    Do_ClusterFit_PV2( aSample, ModuleNber  ,&aSC_VS_x_rc_dd_SET_rc_dd    ) ;
...
//  Characterize OUTPUT
    ...
    TH1F*     Output_pTH1F_PullFitRC                  = GiveMe_pTH1F_PullFitRC_PV2               (aSample, ModuleNber ,TAGOUT) ;

    TH1F*     Output_pTH1F_PullFitCluster             = GiveMe_pTH1F_PullFitCluster_PV2          (aSample, ModuleNber ,TAGOUT) ;

    TH1F*     Output_pTH1F_Ch2MinFitCluster           = GiveMe_pTH1F_Ch2MinFitCluster_PV2        (aSample, ModuleNber ,TAGOUT) ;
    TH1F*     Output_pTH1F_Ch2MinPerDOFFitCluster     = GiveMe_pTH1F_Ch2MinPerDOFFitCluster_PV2  (aSample, ModuleNber ,TAGOUT) ;
...
//  Residual details
    ...
    TH2F* pTH2F_Next2Leading_T = new TH2F("pTH2F_Next2Leading_T" , "pTH2F_Next2Leading_T" ,201, -10., 60., 201,   -5.5 ,   10.5);
    ...
    TH2F* pTH2F_NextNext2Leading_T = new TH2F("pTH2F_NextNext2Leading_T" , "pTH2F_NextNext2Leading_T" ,201, -10., 60., 201,   -15.5 ,   30.5);
...
//
      ...
      aTVectorD_Chi2Min_RCfit.Write("aTVectorD_Chi2Min_RCfit_PV2");

      TVectorD aTVectorD_NODF_RCfit(1) ; 
      aTVectorD_NODF_RCfit[0] = NODF_RCfit ;  
      aTVectorD_NODF_RCfit.Write("aTVectorD_NODF_RCfit_PV2");
