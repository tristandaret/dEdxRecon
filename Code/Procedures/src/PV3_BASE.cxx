...
//
  std::string AnalyseName = "PV3_" + Flavor ;
...
//-------------------------------Fit--------------------------------//
    ...
    int FitResult = Do_SampleFit_PV3(aSample, ModuleNber ,&aSC_VS_x_rc_dd_SET_dd) ;
    RCfit_Kounter_Fit += 1 ;
...
//
    ...
    int       NODF_RCfit    = aSample.FitRes_PV3_Get_NberOfTermsInChi2() - 1 ;
    std::cout << std::endl ;
...
//-------------------------------Do cluster position fit-----------------------------//
    ...
    Do_ClusterFit_PV3( aSample, ModuleNber  ,&aSC_VS_x_rc_dd_SET_rc_dd    ) ;
...
//  Characterize OUTPUT
    ...
    TH1F*     Output_pTH1F_PullFitRC                  = GiveMe_pTH1F_PullFitRC_PV3               (aSample, ModuleNber ,TAGOUT) ;

    TH1F*     Output_pTH1F_PullFitCluster             = GiveMe_pTH1F_PullFitCluster_PV3          (aSample, ModuleNber ,TAGOUT) ;

    TH1F*     Output_pTH1F_Ch2MinFitCluster           = GiveMe_pTH1F_Ch2MinFitCluster_PV3        (aSample, ModuleNber ,TAGOUT) ;
    TH1F*     Output_pTH1F_Ch2MinPerDOFFitCluster     = GiveMe_pTH1F_Ch2MinPerDOFFitCluster_PV3  (aSample, ModuleNber ,TAGOUT) ;
...
//  Residual details
    ...
    TH1F* pTH1F_Leading_A     = new TH1F("pTH1F_Leading_A"     , "pTH1F_Leading_A"     ,201,  -60.5 ,  60.5 ) ; 
    TH1F* pTH1F_Leading_T     = new TH1F("pTH1F_Leading_T"     , "pTH1F_Leading_T"     ,201,   -3.5 ,   3.5 ) ; 
    
    TH1F* pTH1F_NextLeading_A  = new TH1F("pTH1F_NextLeading_A"  , "pTH1F_NextLeading_A"  ,201,  -15.5 ,  15.5 ) ; 
    TH1F* pTH1F_NextLeading_T  = new TH1F("pTH1F_NextLeading_T"  , "pTH1F_NextLeading_T"  ,201,   -3.5 ,   3.5 ) ; 
    TH1F* pTH1F_Next2Leading_T = new TH1F("pTH1F_Next2Leading_T" , "pTH1F_Next2Leading_T" ,201,   -5.5 ,   5.5 ) ; 
    TH2F* pTH2F_Next2Leading_T = new TH2F("pTH2F_Next2Leading_T" , "pTH2F_Next2Leading_T" ,12, -5.5, 6.5, 201,   -3.5 ,   3.5);
    
    TH1F* pTH1F_NextNextLeading_A  = new TH1F("pTH1F_NextNextLeading_A"  , "pTH1F_NextNextLeading_A"  ,201,  -24.5 ,  24.5 ) ; 
    TH1F* pTH1F_NextNextLeading_T  = new TH1F("pTH1F_NextNextLeading_T"  , "pTH1F_NextNextLeading_T"  ,201,  -10.5 ,  10.5 ) ; 
    TH1F* pTH1F_NextNext2Leading_T = new TH1F("pTH1F_NextNext2Leading_T" , "pTH1F_NextNext2Leading_T" ,201,  -15.5 ,  15.5 ) ; 
    ...
    for (int iE = 0 ; iE < NberOfEvents; iE++){          
      ...
      for (int iC = 0 ; iC< NClusters; iC++){
        ...
        double AT     =  pCluster->Get_AT () ;
        double TT     =  pCluster->Get_TT () ;
        
        double Y_Leading = pPad_Leading->Get_YPad() ;
        double A_Leading = pPad_Leading->Get_AMax() ;
        double T_Leading = pPad_Leading->Get_TMax() ;
        
        double YTmYP = YTrack-Y_Leading ;
        ...
        pTH1F_Leading_A->Fill( A_Leading- (AT*AlFa) ) ;
        pTH1F_Leading_T->Fill( T_Leading- (TT+Tau ) ) ;
        
        if (pPad_NextLeading){
          double Y_NextLeading = pPad_NextLeading->Get_YPad() ;
          double A_NextLeading = pPad_NextLeading->Get_AMax() ;
          double T_NextLeading = pPad_NextLeading->Get_TMax() ;
...
//TAGADA
        ...
        DD_Local = DD_Sample ;
          ...
          pTH1F_NextLeading_A->Fill( A_NextLeading- (AT*AlFa) ) ;
          pTH1F_NextLeading_T->Fill( T_NextLeading- (TT+Tau ) ) ;
          
          pTH1F_Next2Leading_T->Fill( T_NextLeading- (T_Leading+Tau ) ) ;

          pTH2F_Next2Leading_T->Fill( (T_NextLeading-  T_Leading) , (T_NextLeading- (T_Leading+Tau ))  ) ;
        }
        
        if (pPad_NextNextLeading){
          double Y_NextNextLeading = pPad_NextNextLeading->Get_YPad() ;
          double A_NextNextLeading = pPad_NextNextLeading->Get_AMax() ;
          double T_NextNextLeading = pPad_NextNextLeading->Get_TMax() ;
...
//TAGADA
        ...
        DD_Local = DD_Sample ;
          ...
          pTH1F_NextNextLeading_A->Fill( A_NextNextLeading- (AT*AlFa) ) ;
          pTH1F_NextNextLeading_T->Fill( T_NextNextLeading- (TT+Tau ) ) ;
          
          pTH1F_NextNext2Leading_T->Fill( T_NextNextLeading- (T_Leading+Tau ) ) ;

          pTH2F_NextNext2Leading_T->Fill( (T_NextNextLeading-  T_Leading) , (T_NextNextLeading- (T_Leading+Tau ))  ) ;
        }
      }
    }         
...
//  Graphics Page 15
    ...
    TH1F* pTH1F_Pull_Leading_A     = new TH1F("pTH1F_Pull_Leading_A"     , "pTH1F_Pull_Leading_A"     ,201,   -5.5 ,   5.5 ) ; 
    TH1F* pTH1F_Pull_Leading_T     = new TH1F("pTH1F_Pull_Leading_T"     , "pTH1F_Pull_Leading_T"     ,201,   -5.5 ,   5.5 ) ;
    ...
    for (int iE = 0 ; iE < NberOfEvents; iE++){          
      ...
      for (int iC = 0 ; iC< NClusters; iC++){
        ...
        double TheError_Time      = TimeError     ( pPad_Leading, pPad_Leading,pPad_NextLeading, pPad_NextNextLeading);
        double TheError_Amplitude = AmplitudeError( pPad_Leading, pPad_Leading,pPad_NextLeading, pPad_NextNextLeading);

        pTH1F_Pull_Leading_A->Fill( (A_Leading- (AT*AlFa))/TheError_Amplitude ) ;
        pTH1F_Pull_Leading_T->Fill( (T_Leading- (TT+Tau ))/TheError_Time      ) ;
        ...
        if (pPad_NextLeading){
          ...
          double TheError_Time      = TimeError     ( pPad_NextLeading, pPad_Leading,pPad_NextLeading, pPad_NextNextLeading);
          double TheError_Amplitude = AmplitudeError( pPad_NextLeading, pPad_Leading,pPad_NextLeading, pPad_NextNextLeading);

          pTH1F_Pull_NextLeading_A->Fill( (A_NextLeading- (AT*AlFa))/TheError_Amplitude ) ;
          pTH1F_Pull_NextLeading_T->Fill( (T_NextLeading- (TT+Tau ))/TheError_Time      ) ;
        }
        ...
        if (pPad_NextNextLeading){
          ...
          double TheError_Time      = TimeError     ( pPad_NextNextLeading, pPad_Leading,pPad_NextLeading, pPad_NextNextLeading);
          double TheError_Amplitude = AmplitudeError( pPad_NextNextLeading, pPad_Leading,pPad_NextLeading, pPad_NextNextLeading);

          pTH1F_Pull_NextNextLeading_A->Fill( (A_NextNextLeading- (AT*AlFa))/TheError_Amplitude ) ;
          pTH1F_Pull_NextNextLeading_T->Fill( (T_NextNextLeading- (TT+Tau ))/TheError_Time      ) ;
        }
      }
    }         
    
    pTCanvas->cd(1);
      pTH1F_Pull_Leading_A  ->Draw();
      pTCanvas->Update();
    
    pTCanvas->cd(4);
      pTH1F_Pull_Leading_T  ->Draw();
      pTCanvas->Update();
...
//
      ...
      aTVectorD_Chi2Min_RCfit.Write("aTVectorD_Chi2Min_RCfit_PV3");

      TVectorD aTVectorD_NODF_RCfit(1) ; 
      aTVectorD_NODF_RCfit[0] = NODF_RCfit ;  
      aTVectorD_NODF_RCfit.Write("aTVectorD_NODF_RCfit_PV3");
...
//
//     delete pTH1F_Leading_A     ;
//     delete pTH1F_Leading_T     ;
