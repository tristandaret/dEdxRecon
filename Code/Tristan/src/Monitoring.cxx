...
void Monitoring()
{
  ...
  std::string Tag    ; 
  std::string Comment = "_zcalc_G2_WF0_LUTvROOT_200_100" ; // z method | gain_corr | WF method
  std::string prtcle ; 
  std::string EvtFile ;
  ...
  if(prototype){
    ...
    if (control or dedx) LUT = GiveMe_LUT(Form("/home/td263283/Documents/Python/LUT_Dt%i_PT%i_nphi200_nd100.root", Dt, PT), nZ, nRC) ;
