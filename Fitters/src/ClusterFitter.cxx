...
StaticClusterFitter_Horizontal::~StaticClusterFitter_Horizontal() {}
void StaticClusterFitter_Horizontal::Set(ClusterFitter_Horizontal* pClusterFitter_Horizontal) { p_ClusterFitter_Horizontal = pClusterFitter_Horizontal; }
...
//
  ...
  if (ierMIGRAD_N==0){
    ...
    if (Verbose==1 && ierMINOS_N!=0) std::cout << " ClusterFitter_Horizontal::DoMinimisation() ierMINOS_N  " << ierMINOS_N << std::endl ;
    ...
    std::cout << std::endl ;
    if (Verbose==1) 
    std::cout << " ClusterFitter_Horizontal::DoMinimisation() normal fitting failed "
    ...
    if (ierMIGRAD_R1==0){
      ...
      if (Verbose==1) 
      std::cout << " ClusterFitter_Horizontal::DoMinimisation() Rescue 1 succeeded "
                << std::endl ;

      int ierMINOS_R1 = p_TVirtualFitter->ExecuteCommand("MINOS"   ,arg ,1) ;
      if (Verbose==1 && ierMINOS_R1!=0) std::cout << " ClusterFitter_Horizontal::DoMinimisation() ->->ierMINOS_R1  " << ierMINOS_R1 << std::endl ;
      ...
      if (Verbose==1) 
      std::cout << " ClusterFitter_Horizontal::DoMinimisation() Rescue 1 failed "
      ...
      if (ierMIGRAD_R2==0){
        ...
        if (Verbose==1) 
        std::cout << " ClusterFitter_Horizontal::DoMinimisation() Rescue 2 succeeded "
                  << std::endl ;

        int ierMINOS_R2 = p_TVirtualFitter->ExecuteCommand("MINOS"   ,arg ,1) ;
        if (Verbose==1 && ierMINOS_R2!=0) std::cout << " ClusterFitter_Horizontal::DoMinimisation() ->->->ierMINOS_R2  " << ierMINOS_R2 << std::endl ;
        ...
        if (Verbose==1) 
        std::cout << " ClusterFitter_Horizontal::DoMinimisation() Rescue 2 failed "
                  << "->ierMIGRAD_R2 " << ierMIGRAD_R2  
                  << std::endl ;
        if (Verbose==1) 
        std::cout << " ClusterFitter_Horizontal::DoMinimisation() All Rescues failed : Failure procedure called  "
                  << std::endl ;
       
        p_Cluster->SetResults_FailledFit_Horizontal(Verbose) ;
...
double ClusterFitter_Horizontal::Chi2(double par[]) { return p_Cluster->Chi2_Horizontal(par) ; }
...
ClusterFitter_Diagonal* StaticClusterFitter_Diagonal::p_ClusterFitter_Diagonal = NULL;

StaticClusterFitter_Diagonal::StaticClusterFitter_Diagonal() {}
StaticClusterFitter_Diagonal::~StaticClusterFitter_Diagonal() {}
void StaticClusterFitter_Diagonal::Set(ClusterFitter_Diagonal* pClusterFitter_Diagonal) { p_ClusterFitter_Diagonal = pClusterFitter_Diagonal; }
...
//
  ...
  if (ierMIGRAD_N==0){
    ...
    int ierMINOS_N = p_TVirtualFitter->ExecuteCommand("MINOS"   ,arg ,1) ;
    if (Verbose==1 && ierMINOS_N!=0) std::cout << " ClusterFitter_Diagonal::DoMinimisation() ierMINOS_N  " << ierMINOS_N << std::endl ;
    ...
    std::cout << std::endl ;
    if (Verbose==1) 
    std::cout << " ClusterFitter_Diagonal::DoMinimisation() normal fitting failed "
              << "->ierMIGRAD_N " << ierMIGRAD_N  
              << std::endl ;
    ...
    if (ierMIGRAD_R1==0){
      ...
      int ierMINOS_R1 = p_TVirtualFitter->ExecuteCommand("MINOS"   ,arg ,1) ;
      if (Verbose==1 && ierMINOS_R1!=0) std::cout << " ClusterFitter_Diagonal::DoMinimisation() ->->ierMINOS_R1  " << ierMINOS_R1 << std::endl ;
      ...
      if (Verbose==1) 
      std::cout << " ClusterFitter_Diagonal::DoMinimisation() Rescue 1 failed "
                << "->ierMIGRAD_R1 " << ierMIGRAD_R1  
                << std::endl ;
      ...
      if (ierMIGRAD_R2==0){
        ...
        if (Verbose==1) 
        std::cout << " ClusterFitter_Diagonal::DoMinimisation() Rescue 2 succeeded "
                  << std::endl ;

        int ierMINOS_R2 = p_TVirtualFitter->ExecuteCommand("MINOS"   ,arg ,1) ;
        if (Verbose==1 && ierMINOS_R2!=0) std::cout << " ClusterFitter_Diagonal::DoMinimisation() ->->->ierMINOS_R2  " << ierMINOS_R2 << std::endl ;
...
double ClusterFitter_Diagonal::Chi2(double par[]) { return p_Cluster->Chi2_Diagonal(par) ; }
