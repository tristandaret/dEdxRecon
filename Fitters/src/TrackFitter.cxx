...
StaticTrackFitter::~StaticTrackFitter() {}
void StaticTrackFitter::Set(TrackFitter *pTrackFitter) {
  p_TrackFitter = pTrackFitter;
}

void TrackFitterFunction(int &nDim, double *gout, double &result, double par[],
                         int flg) {
...
TrackFitter::TrackFitter(const std::string &FitterName,
  ...
  if (ierMIGRAD_N == 0) {
    ...
    if (ierMIGRAD_R1 == 0) {
      ...
      if (ierMIGRAD_R2 == 0) {
        ...
        if (ierMINOS_R2 != 0)
          std::cout
              << " TrackFitter::DoMinimisation() ->->->ierMINOS_R2	"
        ...
        std::cout
            << " TrackFitter::DoMinimisation() All Rescues failed : abort "
            << std::endl;
