...
double Model_ReadOutGeometry::Get_LX() const
{
   return m_LX;
}
double Model_ReadOutGeometry::Get_LY() const
{
   return m_LY;
}
double Model_ReadOutGeometry::Get_Xpad_min() const
{
   return m_Xpad_min;
}
double Model_ReadOutGeometry::Get_Ypad_min() const
{
   return m_Ypad_min;
}
int Model_ReadOutGeometry::Get_Nx() const
{
   return m_Nx;
}
int Model_ReadOutGeometry::Get_Ny() const
{
   return m_Ny;
}

void Model_ReadOutGeometry::Set_LX(const double &LX)
{
   m_LX = LX;
}
void Model_ReadOutGeometry::Set_LY(const double &LY)
{
   m_LY = LY;
}
...
void Model_ReadOutGeometry::Set_Nx(const int &Nx)
{
   m_Nx = Nx;
}
void Model_ReadOutGeometry::Set_Ny(const int &Ny)
{
   m_Ny = Ny;
}
