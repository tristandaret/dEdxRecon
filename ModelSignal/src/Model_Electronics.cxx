...
Model_Electronics::~Model_Electronics() {
  int VerboseDelete = 0;
  if (VerboseDelete == 1)
    std::cout << " Model_Electronics Destructor " << std::endl;
}
...
void Model_Electronics::Set_Amplitude(const double &Amplitude) {
...
void Model_Electronics::WriteOut() const {
  ...
  std::cout << " m_QValue; " << std::setw(13) << std::setprecision(6)
            << m_QValue << std::endl;
  std::cout << " m_ws	; " << std::setw(16) << std::setprecision(3) << m_ws
            << std::endl;
  std::cout << " m_Amplitude; " << std::setw(13) << std::setprecision(6)
            << m_Amplitude << std::endl;
...
double Model_Electronics::Response_Base(const double &Time) const {
  ...
  ToBeReturned = std::exp(-m_ws * Time) +
