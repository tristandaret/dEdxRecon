/**
 * @file DrawOuts_old.h
 * @brief Legacy plotting helpers (kept for reference).
 *
 * Contains an older variant of the DrawOuts plotting helper kept for
 * compatibility and reference. Prefer `DrawOuts` for new code.
 */
