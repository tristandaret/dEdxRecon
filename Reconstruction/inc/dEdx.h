...
public:
  ...
  // GP4: Remove from total GWF the ETF of the top 30% clusters computed with
  // LUT GP5: Remove from total GWF the ETF of the top 30% crossed pads computed
  // with LUT
...
private:
  ...
  // Setup variables
  static constexpr float AVG_GAIN =
      1947.72;                           // average gain of the 32 mounted ERAMs
