...
double Selector::Get_Cut_Stage2_EventBased()
{
   return m_Cut_Stage2_EventBased;
}
...
double Selector::Get_Cut_Stage3_TLow()
{
   return m_Cut_Stage3_TLow;
}
double Selector::Get_Cut_Stage3_THigh()
{
   return m_Cut_Stage3_THigh;
}
...
double Selector::Get_Cut_Stage4_APM_Low()
{
   return m_Cut_Stage4_APM_Low;
}
void Selector::Set_Cut_Stage4_APM_Low(double Cut_Stage4_APM_Low)
{
   m_Cut_Stage4_APM_Low = Cut_Stage4_APM_Low;
}
double Selector::Get_Cut_Stage4_APM_High()
{
   return m_Cut_Stage4_APM_High;
}
...
double Selector::Get_Cut_Stage5_Npads_Hig()
{
   return m_Cut_Stage5_Npads_Hig;
}
...
double Selector::Get_Cut_Stage6_Amax_Low()
{
   return m_Cut_Stage6_Amax_Low;
}
void Selector::Set_Cut_Stage6_Amax_Low(double Cut_Stage6_Amax_Low)
{
   m_Cut_Stage6_Amax_Low = Cut_Stage6_Amax_Low;
}
double Selector::Get_Cut_Stage6_Amax_Hig()
{
   return m_Cut_Stage6_Amax_Hig;
}
...
void Selector::Set_Cut_StageFinal_NCluster_Low(double Cut_StageFinal_NCluster_Low)
{
