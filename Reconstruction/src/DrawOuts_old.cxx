...
void DrawOut_Versions(const std::string &inputDir, const std::string &Method,
  ...
  for (int iy = 0; iy < npoint; iy++) {
    TFile *file1 = TFile::Open(
        TString(inputDir + "DESY21_yscan/DESY21_y" + name_arr[iy] +
                "/3_DESY21_y" + name_arr[iy] + "_dEdx" + Comment1 + ".root"));
    TFile *file2 = TFile::Open(
        TString(inputDir + "DESY21_yscan/DESY21_y" + name_arr[iy] +
                "/3_DESY21_y" + name_arr[iy] + "_dEdx" + Comment2 + ".root"));
  ...
  v_mean1[0]->SetNameTitle("v_mean1[0]",
                           "Mean vs Y position;Pad row;Mean (ADC count)");
  ...
  v_std1[0]->SetNameTitle("v_std1[0]",
                          "Std vs Y position;Pad row;std (ADC count)");
  ...
  for (int i = -1; i < npoint; i++) {
    ...
    if (i == -1) {
      file1 = TFile::Open(TString(inputDir +
                                  "DESY21_zscan/DESY21_zscan_PT200/"
      ...
      file1 = TFile::Open(TString(
          inputDir + "DESY21_zscan/DESY21_zscan_PT200/DESY21_z" + i +
  ...
  v_reso1[1]->SetNameTitle(
      "v_reso1[1]",
      "Resolution vs Z_{drift} (200 ns);Z_{drift} (mm);resolution [%]");
  ...
  v_std1[1]->SetNameTitle(
      "v_std1[1]", "Std vs Z_{drift} (200 ns);Z_{drift} (mm);std (ADC count)");
  ...
  for (int i = -1; i < npoint; i++) {
    ...
    if (i == -1) {
      file1 = TFile::Open(TString(inputDir +
                                  "DESY21_zscan/DESY21_zscan_PT412/"
                                  "DESY21_zm40_PT412/3_DESY21_zm40_PT412_dEdx" +
                                  Comment1 + ".root"));
      file2 = TFile::Open(TString(inputDir +
                                  "DESY21_zscan/DESY21_zscan_PT412/"
                                  "DESY21_zm40_PT412/3_DESY21_zm40_PT412_dEdx" +
      ...
      file1 = TFile::Open(TString(
          inputDir + "DESY21_zscan/DESY21_zscan_PT412/DESY21_z" + i +
  ...
  v_reso1[2]->SetNameTitle(
      "v_reso1[2]",
      "Resolution vs Z_{drift} (412 ns);Z_{drift} (mm);resolution [%]");
  ...
  v_std1[2]->SetNameTitle(
      "v_std1[2]", "Std vs Z_{drift} (412 ns);Z_{drift} (mm);std (ADC count)");
  ...
  for (int i = 0; i < npoint; i++) {
    ...
    if (i == 0)
      ...
      file1 = TFile::Open(
          TString(inputDir + "DESY21_phi/DESY21_phi_zm40/DESY21_phi" +
  ...
  v_reso1[3]->SetNameTitle("v_reso1[3]",
                           "Resolution vs #varphi angle (Z_{drift} = 50 "
  ...
  v_mean1[3]->SetNameTitle("v_mean1[3]",
                           "Mean vs #varphi angle (Z_{drift} = 50 mm);#varphi "
                           "angle (#circ);Mean (ADC count)");
  ...
  v_std1[3]->SetNameTitle("v_std1[3]",
                          "Std vs #varphi angle (Z_{drift} = 50 mm);#varphi "
                          "angle (#circ);std (ADC count)");
  ...
  for (int i = 0; i < npoint; i++) {
    ...
    if (i == 0)
      ...
      file1 = TFile::Open(
          TString(inputDir + "DESY21_phi/DESY21_phi_z460/DESY21_phi" +
  ...
  v_reso1[4]->SetNameTitle("v_reso1[4]",
                           "Resolution vs #varphi angle (Z_{drift} = 550 "
                           "mm);#varphi angle (#circ);resolution [%]");
  ...
  v_mean1[4]->SetNameTitle("v_mean1[4]",
                           "Mean vs #varphi angle (Z_{drift} = 550 "
  ...
  v_std1[4]->SetNameTitle("v_std1[4]",
                          "Std vs #varphi angle (Z_{drift} = 550 mm);#varphi "
                          "angle (#circ);std (ADC count)");
  ...
  for (int i = 0; i < npoint; i++) {
    ...
    if (i == 0)
      ...
      file1 = TFile::Open(
          TString(inputDir + "DESY21_phi/DESY21_phi_z860/DESY21_phi" +
  ...
  v_reso1[5]->SetNameTitle("v_reso1[5]",
                           "Resolution vs #varphi angle (Z_{drift} = 950 "
                           "mm);#varphi angle (#circ);resolution [%]");
  ...
  v_mean1[5]->SetNameTitle("v_mean1[5]",
                           "Mean vs #varphi angle (Z_{drift} = 950 "
                           "mm);#varphi angle (#circ);Mean (ADC count)");
  ...
  v_std1[5]->SetNameTitle("v_std1[5]",
                          "Std vs #varphi angle (Z_{drift} = 950 mm);#varphi "
                          "angle (#circ);std (ADC count)");
...
void DrawOut_Separation(const std::string &inputDir,
  ...
  v_pTFile_dEdx.push_back(TFile::Open(
      TString(inputDir + "CERN22_ERAM18_e+_1GeV" + "/" +
              "3_CERN22_ERAM18_e+_1GeV" + "_dEdx" + Comment + ".root")));
  v_pTFile_dEdx.push_back(TFile::Open(
      TString(inputDir + "CERN22_ERAM18_p_1GeV" + "/" +
              "3_CERN22_ERAM18_p_1GeV" + "_dEdx" + Comment + ".root")));
  v_pTFile_dEdx.push_back(TFile::Open(
      TString(inputDir + "CERN22_ERAM18_mu+_1GeV" + "/" +
              "3_CERN22_ERAM18_mu+_1GeV" + "_dEdx" + Comment + ".root")));
  v_pTFile_dEdx.push_back(TFile::Open(
      TString(inputDir + "CERN22_ERAM18_pi+_0p5GeV" + "/" +
  ...
  TH2F *h2_err_separation =
      new TH2F("h2_err_separation", "Error on separation power", 6, -0.5, 5.5,
               6, -0.5, 5.5);
  ...
  for (int i = 0; i < nParticles; i++) {
    for (int j = i + 1; j < nParticles; j++) {
      ...
      h2_separation->Fill(
          ...
          std::floor(GetSeparation(mean_WFsum[i], std_WFsum[i], mean_WFsum[j],
                                   std_WFsum[j]) *
                     100) /
              100);
      ...
      h2_separation->Fill(methods[4], particles[k],
                          std::floor(GetSeparation(mean_XP[i], std_XP[i],
                                                   mean_XP[j], std_XP[j]) *
                                     100) /
                              100);
      k++;
  ...
  for (int i = 0; i < nParticles; i++) {
    for (int j = i + 1; j < nParticles; j++) {
      h2_err_separation->Fill(
          ...
          std::floor(GetSeparationError(mean_Qtrunc[i], std_Qtrunc[i],
                                        dmean_Qtrunc[i], dstd_Qtrunc[i],
                                        mean_Qtrunc[j], std_Qtrunc[j],
      ...
      h2_err_separation->Fill(
          ...
          std::floor(GetSeparationError(mean_WFsum[i], std_WFsum[i],
                                        dmean_WFsum[i], dstd_WFsum[i],
      ...
      h2_err_separation->Fill(
          ...
          std::floor(GetSeparationError(mean_GPv3[i], std_GPv3[i],
                                        dmean_GPv3[i], dstd_GPv3[i],
                                        mean_GPv3[j], std_GPv3[j],
      ...
      h2_err_separation->Fill(
          ...
          std::floor(GetSeparationError(mean_GPv6[i], std_GPv6[i],
                                        dmean_GPv6[i], dstd_GPv6[i],
                                        mean_GPv6[j], std_GPv6[j],
      ...
      h2_err_separation->Fill(
          ...
          std::floor(GetSeparationError(mean_XP[i], std_XP[i], dmean_XP[i],
                                        dstd_XP[i], mean_XP[j], std_XP[j],
                                        dmean_XP[j], dstd_XP[j]) *
                     100) /
              100);
      dk++;
    }
  ...
  // v_tf1_Qtrunc[0]->			SetParameter(0,
  // v_tf1_Qtrunc[0]->Integral(0, 1500)/v_h1f_Qtrunc[0]->GetEntries());
  // v_h1f_Qtrunc[0]-> SetLineColor(kBlue+3); v_h1f_Qtrunc[0]->
  // SetLineWidth(2); v_tf1_Qtrunc[0]->			SetLineColor(kBlue-6);
  ...
  // v_tf1_Qtrunc[2]->			SetParameter(0,
  // v_tf1_Qtrunc[2]->Integral(0, 1500)/v_h1f_Qtrunc[2]->GetEntries());
  // v_h1f_Qtrunc[2]-> SetLineColor(kBlue+3); v_h1f_Qtrunc[2]->
  // SetLineWidth(2); v_h1f_Qtrunc[2]->			SetLineStyle(2);
  // v_tf1_Qtrunc[2]->			SetLineColor(kBlue-6);
  // v_tf1_Qtrunc[2]->			SetLineWidth(2);
  // if(v_h1f_Qtrunc[0]->GetMaximum() < v_h1f_Qtrunc[2]->GetMaximum())
  // v_h1f_Qtrunc[0]->SetAxisRange(0, 1.1*v_h1f_Qtrunc[2]->GetMaximum(),
  // "Y"); v_h1f_Qtrunc[0]->			Draw("hist"); v_tf1_Qtrunc[0]->
  // Draw("same"); gPad-> Update(); SetStatBoxPosition(v_h1f_Qtrunc[0], 0.64,
  // 0.89, 0.34,	0.32); v_h1f_Qtrunc[2]-> Draw("hist sames");
  // v_tf1_Qtrunc[2]->			Draw("same");
  // gPad->						Update();
  // SetStatBoxPosition(v_h1f_Qtrunc[2], 0.64, 0.89, 0.64,	0.89);
  // pTCanvas->					Update();
  // leg->
  // AddEntry(v_h1f_Qtrunc[2], "#mu^{+} 1GeV ", "l"); leg->
  // AddEntry(v_h1f_Qtrunc[0], "e^{+} 1GeV ", "l"); leg->
  // DrawClone(); pTCanvas->
  // SaveAs(OutputFile.c_str()); pTCanvas->
  // Clear(); leg->						Clear();
  ...
  if (v_h1f_WFsum[0]->GetMaximum() < v_h1f_WFsum[2]->GetMaximum())
    v_h1f_WFsum[0]->SetAxisRange(0, 1.1 * v_h1f_WFsum[2]->GetMaximum(), "Y");
  ...
  float sepa =
      GetSeparation(mean_WFsum[0], std_WFsum[0], mean_WFsum[2], std_WFsum[2]);
  float dsepa = GetSeparationError(mean_WFsum[0], std_WFsum[0], dmean_WFsum[0],
                                   dstd_WFsum[0], mean_WFsum[2], std_WFsum[2],
                                   dmean_WFsum[2], dstd_WFsum[2]);
  ptText->SetText(
      1200, 0.19,
  ...
  // v_tf1_GPv3[0]->			SetParameter(0,
  // v_tf1_GPv3[0]->Integral(0, 1500)/v_h1f_GPv3[0]->GetEntries());
  // v_h1f_GPv3[0]-> SetLineColor(kMagenta+3); v_h1f_GPv3[0]->
  // SetLineWidth(2); v_tf1_GPv3[0]-> SetLineColor(kMagenta-6); v_tf1_GPv3[0]->
  // SetLineWidth(2); v_h1f_GPv3[2]->			SetName("muons #mu^{+}
  // 1GeV"); v_h1f_GPv3[2]->
  // Scale(1/v_h1f_GPv3[2]->GetEntries()); v_tf1_GPv3[2]->
  // SetRange(0, 1500); v_tf1_GPv3[2]->			SetParameter(0,
  // v_tf1_GPv3[2]->Integral(0, 1500)/v_h1f_GPv3[2]->GetEntries());
  // v_h1f_GPv3[2]-> SetLineColor(kMagenta+3); v_h1f_GPv3[2]->
  // SetLineWidth(2); v_h1f_GPv3[2]->			SetLineStyle(2);
  ...
  // v_h1f_GPv3[0]->			Draw("hist"); v_tf1_GPv3[0]->
  // Draw("same"); gPad-> Update(); SetStatBoxPosition(v_h1f_GPv3[0], 0.64,
  // 0.89, 0.34,	0.32); v_h1f_GPv3[2]->			Draw("hist
  // sames"); v_tf1_GPv3[2]->			Draw("same"); gPad->
  // Update(); SetStatBoxPosition(v_h1f_GPv3[2], 0.64, 0.89, 0.64,	0.89);
  // pTCanvas->					Update();
  // leg->						AddEntry(v_h1f_GPv3[2],
  // "#mu^{+} 1GeV ", "l"); leg->
  // AddEntry(v_h1f_GPv3[0], "e^{+} 1GeV ", "l"); leg->
  // DrawClone(); pTCanvas->
  // SaveAs(OutputFile.c_str()); pTCanvas->
  // Clear(); leg->						Clear();
  ...
  // v_tf1_GPv6[0]->			SetParameter(0,
  // v_tf1_GPv6[0]->Integral(0, 1500)/v_h1f_GPv6[0]->GetEntries());
  // v_h1f_GPv6[0]->			SetLineColor(kGreen-2); v_h1f_GPv6[0]->
  // SetLineWidth(2); v_tf1_GPv6[0]->			SetLineColor(kGreen+2);
  ...
  // v_tf1_GPv6[2]->			SetParameter(0,
  // v_tf1_GPv6[2]->Integral(0, 1500)/v_h1f_GPv6[2]->GetEntries());
  // v_h1f_GPv6[2]->			SetLineColor(kGreen-2); v_h1f_GPv6[2]->
  // SetLineWidth(2); v_h1f_GPv6[2]->			SetLineStyle(2);
  ...
  // v_h1f_GPv6[0]->			Draw("hist"); v_tf1_GPv6[0]->
  // Draw("same"); gPad-> Update(); SetStatBoxPosition(v_h1f_GPv6[0], 0.64,
  // 0.89, 0.34,	0.32); v_h1f_GPv6[2]->			Draw("hist
  // sames"); v_tf1_GPv6[2]->			Draw("same"); gPad->
  // Update(); SetStatBoxPosition(v_h1f_GPv6[2], 0.64, 0.89, 0.64,	0.89);
  // pTCanvas->					Update();
  // leg->						AddEntry(v_h1f_GPv6[2],
  // "#mu^{+} 1GeV ", "l"); leg->
  // AddEntry(v_h1f_GPv6[0], "e^{+} 1GeV ", "l"); leg->
  // DrawClone(); pTCanvas->
  // SaveAs(OutputFile.c_str()); pTCanvas->
  // Clear(); leg->						Clear();
  ...
  v_tf1_XP[0]->SetParameter(0, v_tf1_XP[0]->Integral(0, 1500) /
                                   v_h1f_XP[0]->GetEntries());
  ...
  v_tf1_XP[2]->SetParameter(0, v_tf1_XP[2]->Integral(0, 1500) /
                                   v_h1f_XP[2]->GetEntries());
  ...
  if (v_h1f_XP[0]->GetMaximum() < v_h1f_XP[2]->GetMaximum())
    v_h1f_XP[0]->SetAxisRange(0, 1.1 * v_h1f_XP[2]->GetMaximum(), "Y");
  ...
  dsepa = GetSeparationError(mean_XP[0], std_XP[0], dmean_XP[0], dstd_XP[0],
                             mean_XP[2], std_XP[2], dmean_XP[2], dstd_XP[2]);
  ptText->SetText(
      1200, 0.19,
      Form("S(e^{+} | #mu^{+}) = %.2f #pm %.2f #sigma", sepa, dsepa));
...
void DrawOut_Separation_Reduced(const std::string &inputDir,
  ...
  std::vector<TFile *> v_pTFile_dEdx;
  // v_pTFile_dEdx.
  // push_back(TFile::Open(TString(inputDir +
  // "CERN22_ERAM18_e+_1GeV/3_CERN22_ERAM18_e+_1GeV_vD"	+ "_dEdx" + Comment +
  // ".root"))); v_pTFile_dEdx. push_back(TFile::Open(TString(inputDir +
  // "CERN22_ERAM18_p_1GeV/3_CERN22_ERAM18_p_1GeV_vD"		+ "_dEdx" +
  // Comment
  // + ".root"))); v_pTFile_dEdx.
  // push_back(TFile::Open(TString(inputDir +
  // "CERN22_ERAM18_mu+_1GeV/3_CERN22_ERAM18_mu+_1GeV_vD"	+ "_dEdx" +
  // Comment +
  // ".root"))); v_pTFile_dEdx. push_back(TFile::Open(TString(inputDir +
  // "CERN22_ERAM18_pi+_0p5GeV/3_CERN22_ERAM18_pi+_0p5GeV_vD"	+ "_dEdx" +
  // Comment +
  // ".root")));
  v_pTFile_dEdx.push_back(TFile::Open(TString(
      inputDir + "CERN22_Escan_e+_" + Energy + "GeV/3_CERN22_Escan_e+_" +
      Energy + "GeV_dEdx" + Comment + ".root")));
  v_pTFile_dEdx.push_back(TFile::Open(TString(
      inputDir + "CERN22_Escan_p+_" + Energy + "GeV/3_CERN22_Escan_p+_" +
      Energy + "GeV_dEdx" + Comment + ".root")));
  v_pTFile_dEdx.push_back(TFile::Open(TString(
      inputDir + "CERN22_Escan_mu_" + Energy + "GeV/3_CERN22_Escan_mu_" +
      Energy + "GeV_dEdx" + Comment + ".root")));
  v_pTFile_dEdx.push_back(TFile::Open(TString(
      inputDir + "CERN22_Escan_pi_" + Energy + "GeV/3_CERN22_Escan_pi_" +
      Energy + "GeV_dEdx" + Comment + ".root")));
  ...
  int p;
  if ((p = Energy.find("p")) != (int)std::string::npos)
    Energy.replace(p, 1, ".");
  ...
  // Draw
  std::string OutputFile =
      inputDir + "Separation_power_reduced" + Comment + ".png";
  ...
  std::string OutputFile2 =
      inputDir + "Separation_power_emu" + Comment + ".pdf";
  ...
  v_th1_WFsum[0]->SetMaximum(
      std::max({v_th1_WFsum[0]->GetMaximum(), v_th1_WFsum[2]->GetMaximum()}) *
      1.2);
  ...
  v_tf1_WFsum[2]->SetLineWidth(2);
  if (v_th1_WFsum[0]->GetMaximum() < v_th1_WFsum[2]->GetMaximum())
    v_th1_WFsum[0]->SetAxisRange(0, 1.1 * v_th1_WFsum[2]->GetMaximum(), "Y");
  ...
  float dsepa = GetSeparationError(mean_WFsum[0], std_WFsum[0], dmean_WFsum[0],
                                   ...
                                   dmean_WFsum[2], dstd_WFsum[2]);
  ptText->SetText(
      1200, gPad->GetUymin() + (gPad->GetUymax() - gPad->GetUymin()) * 0.9,
      Form("S(e^{+} | #mu^{+}) = %.2f #pm %.2f #sigma", sepa, dsepa));
  ptText->SetTextColor(kCyan + 2);
  ptText->DrawClone();
  delete ptText;
  ...
  v_tf1_XP[2]->SetParameter(0, v_tf1_XP[2]->Integral(0, 1500) /
                                   v_th1_XP[2]->GetEntries());
  v_th1_XP[2]->SetLineColor(kMagenta + 2);
  v_th1_XP[2]->SetLineWidth(2);
  v_th1_XP[2]->SetLineStyle(2);
  v_tf1_XP[2]->SetLineColor(kMagenta);
  v_tf1_XP[2]->SetLineWidth(2);
  if (v_th1_XP[0]->GetMaximum() < v_th1_XP[2]->GetMaximum())
    v_th1_XP[0]->SetAxisRange(0, 1.1 * v_th1_XP[2]->GetMaximum(), "Y");
...
void DrawOut_Scans(const std::string &inputDir, const std::string &Comment,
  ...
  for (int PT : PT_arr) {
    for (int iz = 0; iz < nz; iz++) {
      if (iz == 0)
        pTFile = TFile::Open(
            TString(inputDir + "/DESY21_zscan/DESY21_zscan_PT" + PT +
                    "/DESY21_zm40_PT" + PT + "/3_DESY21_zm40_PT" + PT +
                    "_dEdx" + Comment + ".root"));
      else
        pTFile = TFile::Open(
            TString(inputDir + "/DESY21_zscan/DESY21_zscan_PT" + PT +
                    "/DESY21_z" + std::to_string(iz - 1) + "60_PT" + PT +
                    "/3_DESY21_z" + std::to_string(iz - 1) + "60_PT" + PT +
                    "_dEdx" + Comment + ".root"));
      v_tf1_WF.push_back(pTFile->Get<TF1>("tf1_WFsum"));
      v_tf1_XP.push_back(pTFile->Get<TF1>("tf1_XP"));
      pTFile->Clear();
      Xlabel.push_back("PT" + std::to_string(PT) + "_Z" +
                       std::to_string(iz * 10 + 5) + "_Y8_#varphi0_#theta0");
      npoint++;
    }
  ...
  for (int iy = 0; iy < ny; iy++) {
    pTFile = TFile::Open(TString(inputDir + "/DESY21_yscan/DESY21_y" +
                                 Y_arr[iy] + "/3_DESY21_y" + Y_arr[iy] +
                                 "_dEdx" + Comment + ".root"));
    v_tf1_WF.push_back(pTFile->Get<TF1>("tf1_WFsum"));
    v_tf1_XP.push_back(pTFile->Get<TF1>("tf1_XP"));
    pTFile->Clear();
    Xlabel.push_back("PT412_Z9_Y" + std::to_string(Row_arr[iy]) +
                     "_#varphi0_#theta0");
    npoint++;
  }
  v_TLine.push_back(new TLine(npoint, 0, npoint, 1));
    ...
    for (int iphi = 0; iphi < nphi; iphi++) {
      if (iphi < 5)
        pTFile = TFile::Open(TString(
            ...
            phi_arr[iphi] + "_z" + Z_arr[iz] + "/3_DESY21_phi" + phi_arr[iphi] +
            "_z" + Z_arr[iz] + "_dEdx" + Comment + ".root"));
      else
        pTFile = TFile::Open(TString(inputDir + "/DESY21_phi/DESY21_phi_z" +
                                     Z_arr[iz] + "/DESY21_phi" + phi_arr[iphi] +
                                     "_diag_z" + Z_arr[iz] + "/3_DESY21_phi" +
                                     phi_arr[iphi] + "_diag_z" + Z_arr[iz] +
                                     "_dEdx" + Comment + WFversion + ".root"));
      v_tf1_WF.push_back(pTFile->Get<TF1>("tf1_WFsum"));
      v_tf1_XP.push_back(pTFile->Get<TF1>("tf1_XP"));
      pTFile->Clear();
      if (iphi < 5)
        Xlabel.push_back("PT200_Z" + std::to_string(Ztrue_arr[iz] / 10) +
                         "_Y4_#varphi" + std::to_string(phi_arr[iphi]) +
                         "_#theta0");
      else
        Xlabel.push_back("PT200_Z" + std::to_string(Ztrue_arr[iz] / 10) +
                         "_Y4_#varphi" + std::to_string(phi_arr[iphi]) +
  ...
  for (int itheta = 0; itheta < ntheta; itheta++) {
    pTFile = TFile::Open(TString(
        inputDir + "/DESY21_theta/DESY21_theta" + theta_index[itheta] +
        "/3_DESY21_theta" + theta_index[itheta] + "_dEdx" + Comment + ".root"));
    v_tf1_WF.push_back(pTFile->Get<TF1>("tf1_WFsum"));
    v_tf1_XP.push_back(pTFile->Get<TF1>("tf1_XP"));
    pTFile->Clear();
  ...
  for (int ipoint = 0; ipoint < npoint; ipoint++) {
    ...
    ph1_reso_WF->Fill(Xlabel[ipoint].c_str(),
                      std_WF[ipoint] / mean_WF[ipoint] * 100);
    ph1_reso_XP->Fill(Xlabel[ipoint].c_str(),
                      std_XP[ipoint] / mean_XP[ipoint] * 100);
  ...
  for (int i = 0; i < (int)v_TLine.size(); i++) {
    v_TLine[i]->SetY1(pTCanvas->GetUymin());
    v_TLine[i]->SetY2(pTCanvas->GetUymax());
    v_TLine[i]->Draw();
  }
  ...
  ph1_std_XP->SetNameTitle("ph1_std_XP",
                           "dE/dx: Standard deviation;;std (ADC count)");
...
void DrawOut_Zscan_PT(const std::string &inputDir, const std::string &Comment) {
  ...
  for (int iz = 0; iz < (int)std::size(z_arr); iz++) {
    v_pTFile_200.push_back(TFile::Open(TString(
        inputDir + "/DESY21_zscan_PT200/DESY21_z" + z_arr[iz] +
        "_PT200/3_DESY21_z" + z_arr[iz] + "_PT200_dEdx" + Comment + ".root")));
    v_pTFile_412.push_back(TFile::Open(TString(
        inputDir + "/DESY21_zscan_PT412/DESY21_z" + z_arr[iz] +
  ...
  pTGE_reso_XP_200->SetNameTitle(
      "pTGE_reso_XP",
      "Resolution vs drift distance;drift distance (mm);resolution [%]");
  ...
  pTGE_mean_XP_200->SetNameTitle(
      "pTGE_mean_XP",
      "Mean vs drift distance;drift distance (mm);Mean (ADC count)");
  ...
  pTGE_std_XP_200->SetNameTitle(
      "pTGE_std_XP",
      "std vs drift distance;drift distance (mm);std (ADC count)");
...
void DrawOut_Phiscan_Z(const std::string &inputDir, const std::string &Comment,
  ...
  for (int iphi = 0; iphi < nphi; iphi++) {
    if (iphi == 0) {
      pTFile_5 = TFile::Open(
          TString("OUT_Reconstruction/DESY21_zscan/DESY21_zscan_PT200/"
                  "DESY21_zm40_PT200/3_DESY21_zm40_PT200_dEdx" +
                  Comment + ".root"));
      ...
      // "_zm40/3_DESY21_phi" + phi_arr[iphi] + "_zm40_dEdx" + Comment +
      // ".root"))); v_pTFile_55. push_back(TFile::Open(TString(inputDir +
      // "/DESY21_phi_z460/DESY21_phi" + phi_arr[iphi] +
      // "_z460/3_DESY21_phi" + phi_arr[iphi] + "_z460_dEdx" + Comment +
      // ".root"))); v_pTFile_95. push_back(TFile::Open(TString(inputDir +
      // "/DESY21_phi_z860/DESY21_phi" + phi_arr[iphi] +
      // "_z860/3_DESY21_phi" + phi_arr[iphi] + "_z860_dEdx" + Comment +
      // ".root")));
    } else if (iphi < 5) {
      pTFile_5 = TFile::Open(TString(inputDir + "/DESY21_phi_zm40/DESY21_phi" +
                                     phi_arr[iphi] + "_zm40/3_DESY21_phi" +
                                     phi_arr[iphi] + "_zm40_dEdx" + Comment +
                                     ".root"));
      pTFile_55 = TFile::Open(TString(inputDir + "/DESY21_phi_z460/DESY21_phi" +
                                      phi_arr[iphi] + "_z460/3_DESY21_phi" +
                                      phi_arr[iphi] + "_z460_dEdx" + Comment +
                                      ".root"));
      pTFile_95 = TFile::Open(TString(inputDir + "/DESY21_phi_z860/DESY21_phi" +
                                      phi_arr[iphi] + "_z860/3_DESY21_phi" +
                                      phi_arr[iphi] + "_z860_dEdx" + Comment +
                                      ".root"));
    } else {
      pTFile_5 = TFile::Open(TString(inputDir + "/DESY21_phi_zm40/DESY21_phi" +
                                     phi_arr[iphi] + "_diag_zm40/3_DESY21_phi" +
                                     phi_arr[iphi] + "_diag_zm40_dEdx" +
                                     Comment + WFversion + ".root"));
      pTFile_55 = TFile::Open(
          TString(inputDir + "/DESY21_phi_z460/DESY21_phi" + phi_arr[iphi] +
                  "_diag_z460/3_DESY21_phi" + phi_arr[iphi] +
                  "_diag_z460_dEdx" + Comment + WFversion + ".root"));
      pTFile_95 = TFile::Open(
          TString(inputDir + "/DESY21_phi_z860/DESY21_phi" + phi_arr[iphi] +
  ...
  std::string OutputFile_XP =
      inputDir + "/Phiscan_Resolution_Z" + Comment + "_XP.pdf";
  ...
  pTGE_mean_WF_55->SetNameTitle(
      "pTGE_mean_WF_55",
      "Mean vs #varphi angle;#varphi angle (#circ);mean (ADC count)");
  ...
  pTGE_std_WF_55->SetNameTitle(
      "pTGE_std_WF_55",
      "Std vs #varphi angle;#varphi angle (#circ);std (ADC count)");
...
void DrawOut_Escan(const std::string &inputDir, const std::string &Comment) {
  ...
  gStyle->SetPadTickY(1);
  int npoint = 14;
  std::string Tag[] = {"CERN22_Escan_e+_0p5GeV",  "CERN22_Escan_e+_0p75GeV",
                       "CERN22_Escan_e+_1GeV",    "CERN22_Escan_e+_1p25GeV",
                       "CERN22_Escan_e+_1p5GeV",  "CERN22_Escan_mu_0p75GeV",
                       "CERN22_Escan_mu_1GeV",    "CERN22_Escan_mu_1p5GeV",
                       "CERN22_Escan_pi_0p75GeV", "CERN22_Escan_pi_1p25GeV",
                       "CERN22_Escan_pi_1p5GeV",  "CERN22_Escan_p+_1GeV",
                       "CERN22_Escan_p+_1p25GeV", "CERN22_Escan_p+_1p5GeV"};

  float E_arr[] = {0.5, 0.75, 1,    1.25, 1.5, 0.75, 1,
                   1.5, 0.75, 1.25, 1.5,  1,   1.25, 1.5};
  ...
  for (int iE = 0; iE < npoint; iE++) {
    TFile *ptfile = new TFile(
        (inputDir + Tag[iE] + "/3_" + Tag[iE] + "_dEdx" + Comment + ".root")
            .c_str());
    v_tf1_WF.push_back(ptfile->Get<TF1>("tf1_WFsum"));
    v_tf1_XP.push_back(ptfile->Get<TF1>("tf1_XP"));
    delete ptfile;
  ...
  std::vector<double> v_mass{0.511e-3, 105.658e-3, 139.570e-3,
                             938.272e-3}; // GeV
  ...
  for (int i = 0; i < 4; i++) {
    ...
    v_tf1_BB_THATReconstruction.push_back(
        BetheBlochExp(0.25, 20, v_mass[i], particles[i])); // m & P range in
    // if(i==0) v_tf1_BB.		push_back(BetheBlochExp(0.25, 2,
    // v_mass[i], particles[i])); // m & P range in GeV GeV else
    // v_tf1_BB. push_back(BetheBloch(0.25, 2, v_mass[i], particles[i])); // m &
    // P range in GeV
  }
  ...
  float keV = 5.9 / (224 * 1703.74 /
                     183); // 5.9 Fe peak energy | 1703 mean MockUp gain | 224
                           // e- created with 5.9keV | 183 e- for 1 ADC | 2.23
                           // scaling correction (to be understood)
  ...
  for (int iE = 0; iE < npoint; iE++) {
    ...
    v_pTGE_reso_WF[index]->SetPoint(n[iE], E_arr[iE],
                                    std_WF[iE] / mean_WF[iE] * 100);
    v_pTGE_reso_XP[index]->SetPoint(n[iE], E_arr[iE],
                                    std_XP[iE] / mean_XP[iE] * 100);
  ...
  for (int ipart = 0; ipart < (int)v_tf1_BB_Claudio.size(); ipart++) {
    for (int iparam = 1; iparam < (int)v_tf1_BB_Claudio[0]->GetNpar();
         iparam++) {
  ...
  leg1->SetFillStyle(0);
  TLegend *leg2 =
      new TLegend(x_leg + dx_leg, y_leg, x_leg + 2 * dx_leg, y_leg + dy_leg);
  ...
  v_pTGE_reso_WF[0]->SetNameTitle(
      "pTGE_reso_WF",
      "Resolution vs energy with WF method;Energy (GeV);resolution [%]");
  for (int i = 0; i < 4; i++) {
    Graphic_setup(v_pTGE_reso_WF[i], 3, markers[i], colors[i], 1, colors[i]);
    if (i == 0)
      v_pTGE_reso_WF[i]->Draw("ap");
    else
      v_pTGE_reso_WF[i]->Draw("p same");
    if (i < 2)
      leg1->AddEntry(v_pTGE_reso_WF[i], particles[i].c_str(), "ep");
    else
      leg2->AddEntry(v_pTGE_reso_WF[i], particles[i].c_str(), "ep");
  }
  leg1->Draw();
  leg2->Draw();
  pTCanvas->SaveAs(OutputFile_Beg.c_str());
  ...
  v_pTGE_reso_XP[0]->SetNameTitle(
      "pTGE_reso_XP",
      "Resolution vs energy with XP method;Energy (GeV);resolution [%]");
  for (int i = 0; i < 4; i++) {
    Graphic_setup(v_pTGE_reso_XP[i], 3, markers[i], colors[i], 1, colors[i]);
    if (i == 0)
      v_pTGE_reso_XP[i]->Draw("ap");
    else
      v_pTGE_reso_XP[i]->Draw("p same");
  }
  leg1->Draw();
  leg2->Draw();
  pTCanvas->SaveAs(OutputFile.c_str());
  ...
  v_pTGE_mean_WF[0]->SetNameTitle(
      "pTGE_mean_WF",
      "Mean vs energy with WF method;Energy (GeV);mean (keV/cm)");
  for (int i = 0; i < 4; i++) {
    Graphic_setup(v_pTGE_mean_WF[i], 3, markers[i], colors[i], 1, colors[i]);
    if (i == 0)
      v_pTGE_mean_WF[i]->Draw("ap");
    else
      v_pTGE_mean_WF[i]->Draw("p same");
  ...
  v_pTGE_mean_XP[0]->SetNameTitle(
      "pTGE_mean_XP",
      "Mean vs energy with XP method;Energy (GeV);mean (keV/cm)");
  for (int i = 0; i < 4; i++) {
    Graphic_setup(v_pTGE_mean_XP[i], 3, markers[i], colors[i], 1, colors[i]);
    if (i == 0)
      v_pTGE_mean_XP[i]->Draw("ap");
    else
      v_pTGE_mean_XP[i]->Draw("p same");
    v_tf1_BB[i]->Draw("same");
    v_tf1_BB_Claudio[i]->Draw("same");
    v_tf1_BB_THATReconstruction[i]->Draw("same");
  }
  ...
  for (int i = 0; i < 4; i++) {
    ...
    if (i == 0)
      v_pTGE_std_WF[i]->Draw("ap");
    else
      v_pTGE_std_WF[i]->Draw("p same");
  }
  leg1->Draw();
  leg2->Draw();
  pTCanvas->SaveAs(OutputFile.c_str());
  ...
  for (int i = 0; i < 4; i++) {
    ...
    if (i == 0)
      v_pTGE_std_XP[i]->Draw("ap");
    else
      v_pTGE_std_XP[i]->Draw("p same");
  }
  leg1->Draw();
  leg2->Draw();
  pTCanvas->SaveAs(OutputFile_End.c_str());
  ...
  for (int i = 0; i < (int)v_pTGE_mean_WF.size(); i++) {
    delete v_pTGE_reso_WF[i];
    v_pTGE_reso_WF[i] = 0;
    delete v_pTGE_reso_XP[i];
    v_pTGE_reso_XP[i] = 0;
    delete v_pTGE_mean_WF[i];
    v_pTGE_mean_WF[i] = 0;
    delete v_pTGE_mean_XP[i];
    v_pTGE_mean_XP[i] = 0;
    delete v_pTGE_std_WF[i];
    v_pTGE_std_WF[i] = 0;
    delete v_pTGE_std_XP[i];
    v_pTGE_std_XP[i] = 0;
    delete v_tf1_BB[i];
    v_tf1_BB[i] = 0;
    delete v_tf1_BB_Claudio[i];
    v_tf1_BB_Claudio[i] = 0;
    delete v_tf1_BB_THATReconstruction[i];
    v_tf1_BB_THATReconstruction[i] = 0;
  }
...
void DrawOut_Systematics(const std::string &inputDir,
  ...
  if (sys_RC == 1)
    OutputFile = OutputFile + "_RC";
  if (sys_Z == 1)
    OutputFile = OutputFile + "_Z";
  if (sys_d == 1)
    OutputFile = OutputFile + "_d";
  ...
  for (std::string tag : arr) {
    if (scan == "Z")
      file.push_back((inputDir + "DESY21_z" + tag + "_PT412/3_DESY21_z" + tag +
                      "_PT412_dEdx")
                         .c_str());
    if (scan == "phi")
      file.push_back((inputDir + "DESY21_phi" + tag + "_z460/3_DESY21_phi" +
                      tag + "_z460_dEdx")
                         .c_str());
  }
  if (scan == "phi")
    file[0] =
        "OUT_Reconstruction/DESY21_zscan/DESY21_zscan_PT200/DESY21_z460_PT200/"
        "3_DESY21_z460_PT200_dEdx";

  for (int i = 0; i < (int)file.size(); i++) {
    pTFile_XP = TFile::Open(TString(file[i] + Comment + ".root"));
    TF1 *tf1_XP = pTFile_XP->Get<TF1>("tf1_XP");
    pTGE_reso_XP->SetPoint(
        i, val[i], tf1_XP->GetParameter(2) / tf1_XP->GetParameter(1) * 100);
  ...
  if (sys_RC) {
    ...
    for (int i = 0; i < (int)file.size(); i++) {
      ...
      // pTFile_RCpm					=
      // TFile::Open(TString(file[i] + Comment +
      // "_RCpm%.root")); TF1* tf1_RCpm				=
      // pTFile_RCpm->Get<TF1>("tf1_XP"); pTGE_reso_RCpm->
      // SetPoint(	i,val[i],
      // tf1_RCpm->GetParameter(2)/tf1_RCpm->GetParameter(1)*100);
      // pTGE_reso_RCpm-> SetPointError(i,0,		GetResoError(tf1_RCpm));
      // pTGE_mean_RCpm-> SetPoint(	i,val[i], tf1_RCpm->GetParameter(1));
      // pTGE_mean_RCpm-> SetPointError(i,0,
      // tf1_RCpm->GetParError(1)); pTGE_std_RCpm-> SetPoint(	i,val[i],
      // tf1_RCpm->GetParameter(2)); pTGE_std_RCpm-> SetPointError(i,0,
      // tf1_RCpm->GetParError(2));
    }
    // Resolution
    ...
    if (scan == "Z")
      pTGE_reso_XP->SetNameTitle("pTGE_reso_XP",
                                 "Z scan systematics | RC | Resolution;drift "
                                 "distance (mm);resolution [%]");
    if (scan == "phi")
      pTGE_reso_XP->SetNameTitle("pTGE_reso_XP",
                                 "#phi scan systematics | RC | Resolution;#phi "
    ...
    // leg->
    // AddEntry(pTGE_reso_RCpm, "RC #pm 25%", "ep");
    leg->Draw();
    pTCanvas->SaveAs(OutputFile_Beg.c_str());
    // Mean
    pTCanvas->Clear();
    ...
    if (scan == "Z")
      pTGE_mean_XP->SetNameTitle("pTGE_mean_XP",
                                 "Z scan systematics | RC | Mean;drift "
                                 "distance (mm);mean (ADC count)");
    if (scan == "phi")
      pTGE_mean_XP->SetNameTitle("pTGE_mean_XP",
                                 "#phi scan systematics | RC | Mean;#phi angle "
                                 "(#circ);mean (ADC count)");
  ...
  if (sys_Z) {
    ...
    for (int i = 0; i < (int)file.size(); i++) {
      ...
      pTGE_reso_Zm->SetPoint(
          i, val[i], tf1_Zm->GetParameter(2) / tf1_Zm->GetParameter(1) * 100);
      ...
      pTGE_reso_Zp->SetPoint(
          i, val[i], tf1_Zp->GetParameter(2) / tf1_Zp->GetParameter(1) * 100);
      ...
      // pTFile_Zpm				= TFile::Open(TString(file[i] +
      // Comment +
      // "_Zpmcm.root")); TF1* tf1_Zpm				=
      // pTFile_Zpm->Get<TF1>("tf1_XP"); pTGE_reso_Zpm->
      // SetPoint(	i,val[i],
      ...
      // pTGE_std_Zpm->				SetPoint(	i,val[i],
      // tf1_Zpm->GetParameter(2)); pTGE_std_Zpm->
      // SetPointError(i,0,		tf1_Zpm->GetParError(2));
    }
    pTCanvas->Clear();
    leg->Clear();
    // Resolution
    ...
    if (scan == "Z")
      pTGE_reso_XP->SetNameTitle(
          "pTGE_reso_XP", "Z scan systematics | Z_{drift} | Resolution;drift "
                          "distance (mm);resolution [%]");
    if (scan == "phi")
      pTGE_reso_XP->SetNameTitle(
          "pTGE_reso_XP", "#phi scan systematics | Z_{drift} | Resolution;#phi "
                          "angle (#circ);resolution [%]");
    ...
    // leg->
    // AddEntry(pTGE_reso_Zpm, "Z #pm 10 cm", "ep");
    leg->Draw();
    if (!sys_RC)
      pTCanvas->SaveAs(OutputFile_Beg.c_str());
    else
    ...
    if (scan == "Z")
      pTGE_mean_XP->SetNameTitle("pTGE_mean_XP",
                                 "Z scan systematics | Z_{drift} | Mean;drift "
                                 "distance (mm);mean (ADC count)");
    if (scan == "phi")
      pTGE_mean_XP->SetNameTitle(
          "pTGE_mean_XP", "#phi scan systematics | Z_{drift} | Mean;#phi angle "
                          "(#circ);mean (ADC count)");
    ...
    if (scan == "Z")
      pTGE_std_XP->SetNameTitle(
          "pTGE_std_XP", "Z scan systematics | Z_{drift} | Std;drift distance "
                         "(mm);standard deviation (ADC count)");
    if (scan == "phi")
      pTGE_std_XP->SetNameTitle(
          "pTGE_std_XP", "#phi scan systematics | Z_{drift} | Std;#phi angle "
                         "(#circ);standard deviation (ADC count)");
  ...
  if (sys_d) {
    ...
    for (int i = 0; i < (int)file.size(); i++) {
      ...
      pTGE_reso_dpdd->SetPoint(i, val[i],
                               tf1_dpdd->GetParameter(2) /
                                   tf1_dpdd->GetParameter(1) * 100);
      ...
      pTGE_reso_dmdd->SetPoint(i, val[i],
                               tf1_dmdd->GetParameter(2) /
                                   tf1_dmdd->GetParameter(1) * 100);
    ...
    if (scan == "Z")
      pTGE_reso_XP->SetNameTitle(
          "pTGE_reso_XP", "Z scan systematics | impact parameter d | "
                          "Resolution;drift distance (mm);resolution [%]");
    if (scan == "phi")
      pTGE_reso_XP->SetNameTitle(
          "pTGE_reso_XP", "#phi scan systematics | impact parameter d | "
    ...
    if (scan == "Z")
      pTGE_std_XP->SetNameTitle(
          "pTGE_std_XP", "Z scan systematics | impact parameter d | Std;drift "
                         "distance (mm);standard deviation (ADC count)");
    if (scan == "phi")
      pTGE_std_XP->SetNameTitle(
          "pTGE_std_XP",
          "#phi scan systematics | impact parameter d | Std;#phi angle "
          "(#circ);standard deviation (ADC count)");
    Graphic_setup(pTGE_std_XP, 3, 21, kMagenta + 1, 1, kBlack);
