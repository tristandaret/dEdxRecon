...
void Reconstruction::Monitoring()
{
	...
	if(prototype){
		...
		for (int iFile : part_arr) {
			if (iFile == 0) { v_datafiles.push_back(data_scanfolder + "ERAM18_350V_412ns_e+_0p5GeV_iter0.root");							v_tags.push_back("e+_0p5GeV");	}
			if (iFile == 1) { v_datafiles.push_back(data_scanfolder + "ERAM18_350V_412ns_e+_1GeV_iter0.root");							v_tags.push_back("e+_1GeV");	}
			if (iFile == 2) { v_datafiles.push_back(data_scanfolder + "ERAM18_350V_412ns_p_1GeV_iter0.root");							v_tags.push_back("p_1GeV");		}
			if (iFile == 3) { v_datafiles.push_back(data_scanfolder + "ERAM18_350V_412ns_mu-_1GeV_iter0.root");							v_tags.push_back("mu-_1GeV");	}
			if (iFile == 4) { v_datafiles.push_back(data_scanfolder + "ERAM18_350V_412ns_mu+_0p75GeV_iter0.root");						v_tags.push_back("mu+_0p75GeV");}
			if (iFile == 5) { v_datafiles.push_back(data_scanfolder + "ERAM18_350V_412ns_mu+_1GeV_iter0.root");							v_tags.push_back("mu+_1GeV");	}
			if (iFile == 6) { v_datafiles.push_back(data_scanfolder + "ERAM18_350V_412ns_pi+_0p5GeV_iter0.root");						v_tags.push_back("pi+_0p5GeV");	}
		}
	}
	...
	if(CERN_Escan){
		...
		int part_arr[] = {7};
		for (int iFile : part_arr) {
			if (iFile == 0) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_e+_0p5GeV_25V_z415_y2pad_iter0.root");		v_tags.push_back("e+_0p5GeV");	}
			if (iFile == 1) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_e+_0p75GeV_25V_z415_y2pad_iter0.root");		v_tags.push_back("e+_0p75GeV");	}
			if (iFile == 2) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_e+_1GeV_25V_z415p1_y2pad_iter0.root");		v_tags.push_back("e+_1GeV");	}
			if (iFile == 3) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_e+_1p25GeV_25V_z415p1_y2pad_1_iter0.root");	v_tags.push_back("e+_1p25GeV");	}
			if (iFile == 4) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_e+_1p5GeV_25V_z415p1_y2pad_iter0.root");		v_tags.push_back("e+_1p5GeV");	}
			if (iFile == 5) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_mu+_0p75GeV_25V_z415_y2pad_iter0.root");		v_tags.push_back("mu_0p75GeV");	}
			if (iFile == 6) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_mu+_1GeV_25V_z415p1_y2pad_iter0.root");		v_tags.push_back("mu_1GeV");	}
			if (iFile == 7) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_mu+_1p5GeV_25V_z415p1_y2pad_iter0.root");		v_tags.push_back("mu_1p5GeV");	}
			if (iFile == 8) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_pi+_0p75GeV_25V_z415_y2pad_iter0.root");		v_tags.push_back("pi_0p75GeV");	}
			if (iFile == 9) {v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_pi+_1p25GeV_25V_z415p1_y2pad_2_iter0.root");	v_tags.push_back("pi_1p25GeV");	}
			if (iFile == 10){v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_pi+_1p5GeV_25V_z415p1_y2pad_iter0.root");		v_tags.push_back("pi_1p5GeV");	}
			if (iFile == 11){v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_p_1GeV_25V_z415p1_y2pad_iter0.root");			v_tags.push_back("p+_1GeV");	}
			if (iFile == 12){v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_p_1p25GeV_25V_z415p1_y2pad_iter0.root");		v_tags.push_back("p+_1p25GeV");	}
			if (iFile == 13){v_datafiles.push_back(data_scanfolder + "All_ERAMS_350V_412ns_p_1p5GeV_25V_z415_y2pad_2_iter0.root");		v_tags.push_back("p+_1p5GeV");	}
	...
	if(CERN_drift){
		...
		for (int iz = 0; iz < NFiles; iz++){
			...
			v_datafiles.		push_back(data_scanfolder + "All_ERAMS_350V_412ns_e+_0p5GeV_25V_z" + z + "_iter4.root");	
	...
	if(DESY_drift){
		...
		for (int iPT : PT_arr){
			...
			for (int iz = 0; iz < (int)std::size(v_valstr); iz++){
				const char* z = 	v_valstr[iz].c_str();
				driftDist = 		v_valint[iz];
				v_datafiles.		push_back(Form("../Data/Data_DESY21/Drift_scan_PT%i/z_360_275_%i_02T_26_%s_iter9.root", iPT, iPT, z)); v_tags.push_back(Form("DESY21_z%s_PT%i", z, iPT));
		...
		for (int iz = 0; iz < (int)std::size(v_valstr); iz++){
			...
			for (int ifile = 0; ifile < (int)std::size(phi_val); ifile++){
				...
				if(ifile == 0){		drawout_scanfolder = drawout_folder + "/DESY21_Drift_Scan/DESY21_Drift_Scan_PT200/"; 
									v_datafiles.push_back(Form("../Data/Data_DESY21/zscan_PT200/z_360_275_200_02T_26_%s_iter9.root", z));				v_tags.push_back(Form("DESY21_z%s_PT200", z));}
				if(ifile < 5)		{v_datafiles.push_back(Form("../Data/Data_DESY21/Phi_scan_z%s/phi_200_%i_z%s_ym60_iter9.root", z, phi, z));		v_tags.push_back(Form("DESY21_phi%i_z%s", phi, z));}
				else				{v_datafiles.push_back(Form("../Data/Data_DESY21/Phi_scan_z%s/phi_200_%i_z%s_ym60_diag_iter9.root", z, phi, z));	v_tags.push_back(Form("DESY21_phi%i_diag_z%s", phi, z));
	...
	if(DESY_theta){
		...
		for (std::string theta : theta_arr){
			v_datafiles.push_back(Form("../Data/Data_DESY21/Theta_scan/theta_%s_02T_z460_ym60_iter9.root", theta.c_str())); v_tags.push_back(Form("DESY21_theta%s", theta.c_str()));
