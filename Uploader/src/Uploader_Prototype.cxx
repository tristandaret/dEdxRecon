#/***************************************************************************
 * File: Uploader_Prototype.cxx
 * Project: dEdxRecon
 *
 * Brief: Implementation of the prototype uploader which reads prototype
 *        dataset formats and returns Event objects. Used for prototype data
 *        ingestion in the reconstruction pipeline.
 *
 * Contents: constructor and GiveMe_Event implementation.
 *
 * Notes: See Uploader_Prototype.h for API.
 ***************************************************************************/
...
Event *Uploader_Prototype::GiveMe_Event(const int &iEvent,
