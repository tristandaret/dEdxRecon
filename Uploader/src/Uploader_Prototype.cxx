...
Uploader_Prototype::Uploader_Prototype(const std::string &SampleFile, Model_ReadOutGeometry *pModel_ReadOutGeometry,
...
Event *Uploader_Prototype::GiveMe_Event(const int &iEvent, const int &ModuleNber_Input, const int &Data_to_Use)
{
