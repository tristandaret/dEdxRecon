#/***************************************************************************
 * File: ParabolaFunction.cxx
 * Project: dEdxRecon
 *
 * Brief: Implementation of a simple parabola function helper used in fits
 *        and curve approximations. Provides operator() compatible with
 *        ROOT's TF1 interface.
 *
 * Contents: ParabolaFunction methods.
 *
 * Notes: See ParabolaFunction.h for the interface.
 ***************************************************************************/
