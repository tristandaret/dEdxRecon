...
Uploader_CERN22_V4::Uploader_CERN22_V4(
...
{  
  std::cout << std::endl ;
  std::cout << "  Uploader_CERN22_V4::Uploader_CERN22_V4 "<< std::endl ;
}


Uploader_CERN22_V4::~Uploader_CERN22_V4()
{
//std::cout << " In Uploader_CERN22_V4::~Uploader_CERN22_V4() " << std::endl ;
}

Event* Uploader_CERN22_V4::GiveMe_Event(
                               const int& iEvent, 
...
Event* Uploader_CERN22_V4::GiveMe_Event(
  ...
  std::cout << " Uploader_CERN22_V4::GiveMe_Event iEvent = " << iEvent << std::endl ;
...
//    Find the time shift to be applied on the WF
      double FindMax_ADC      = 0 ;
      int    FindMax_iTimeBin = 0 ;
      for (Int_t iTimeBin = iTimeBin_Min; iTimeBin < iTimeBin_Max; iTimeBin++){
        if (iTimeBin==0){
          FindMax_ADC      = pad_wf_q[iCluster][iPad][iTimeBin] ;
          FindMax_iTimeBin = iTimeBin ;
        }
        if (FindMax_ADC<pad_wf_q[iCluster][iPad][iTimeBin]){
          FindMax_ADC      = pad_wf_q[iCluster][iPad][iTimeBin] ;
          FindMax_iTimeBin = iTimeBin ;
        }
      }
      int TimeBin_Shift = pad_time[iCluster][iPad] - FindMax_iTimeBin ;

      pPad->Clear_ADC() ;
      for (Int_t iTimeBin = iTimeBin_Min; iTimeBin < iTimeBin_Max; iTimeBin++){
        int iTimeBinProper = iTimeBin + TimeBin_Shift ;
